...
public class MacroExpansionStep implements IMacroExpansionStep {
    ...
    final public String fBefore;

    final public IMacroBinding fMacroDefinition;

    final public ReplaceEdit[] fReplacements;

    final public IASTFileLocation fMacroLocation;
