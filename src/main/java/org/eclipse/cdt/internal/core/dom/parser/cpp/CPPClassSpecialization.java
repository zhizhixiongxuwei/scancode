...
public class CPPClassSpecialization extends CPPSpecialization implements ICPPClassSpecialization, ICPPInternalClassTypeMixinHost {
    ...
    public final static class RecursionResolvingConstructor extends RecursionResolvingMethod implements ICPPConstructor {
    ...
    public ICPPClassSpecializationScope specScope;

    public ObjectMap specializationMap = ObjectMap.EMPTY_MAP;

    public ICPPBase[] bases;

    final public ThreadLocal<Set<IBinding>> fInProgress = new ThreadLocal<>() {
