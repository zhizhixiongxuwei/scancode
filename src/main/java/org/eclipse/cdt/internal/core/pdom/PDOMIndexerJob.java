...
public class PDOMIndexerJob extends Job {
    ...
    static final public int PROGRESS_UPDATE_INTERVAL = 500;

    static final public int TOTAL_MONITOR_WORK = 1000;

    static volatile public String sMonitorDetail = null;

    final public PDOMManager pdomManager;

    public IPDOMIndexerTask currentTask;
                ...
                if (currentTask != null) {
                    try {
                        ...
                        if (fShowActivity) {
                            ...
                            System.out.println("Indexer: completed " + name + "[" + time + "ms]");
                        }
                    } catch (InterruptedException e) {
