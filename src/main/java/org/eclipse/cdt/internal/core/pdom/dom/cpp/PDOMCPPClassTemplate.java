...
public class PDOMCPPClassTemplate extends PDOMCPPClassType implements ICPPClassTemplate, ICPPInstanceCache, IPDOMCPPTemplateParameterOwner {
    ...
    static final public int PARAMETERS = PDOMCPPClassType.RECORD_SIZE + 0;

    static final public short RELEVANT_PARAMETERS = PDOMCPPClassType.RECORD_SIZE + 4;

    static final public int FIRST_PARTIAL = PDOMCPPClassType.RECORD_SIZE + 6;

    /**
     * The size in bytes of a PDOMCPPClassTemplate record in the database.
     */
    @SuppressWarnings("hiding")
    static final public int RECORD_SIZE = PDOMCPPClassType.RECORD_SIZE + 10;

    // Cached template parameters.
    volatile public ICPPTemplateParameter[] params;

    public PDOMCPPClassTemplate(PDOMCPPLinkage linkage, PDOMNode parent, ICPPClassTemplate template, boolean visibleToAdlOnly) throws CoreException, DOMException {
    ...
    public ICPPClassTemplatePartialSpecialization[] getPartialSpecializations() {
        try {
            ...
            for (PDOMCPPClassTemplatePartialSpecialization partial = getFirstPartial(); partial != null; partial = partial.getNextPartial()) {
