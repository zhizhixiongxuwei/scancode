...
public class ExecBuiltin implements ICPPExecution {
    ...
    public final static short BUILTIN_FFS = 0, BUILTIN_FFSL = 1, BUILTIN_FFSLL = 2, BUILTIN_CTZ = 3, BUILTIN_CTZL = 4, BUILTIN_CTZLL = 5, BUILTIN_POPCOUNT = 6, BUILTIN_POPCOUNTL = 7, BUILTIN_POPCOUNTLL = 8, BUILTIN_PARITY = 9, BUILTIN_PARITYL = 10, BUILTIN_PARITYLL = 11, BUILTIN_ABS = 12, BUILTIN_LABS = 13, BUILTIN_LLABS = 14, BUILTIN_CLRSB = 15, BUILTIN_CLRSBL = 16, BUILTIN_CLRSBLL = 17, BUILTIN_CLZ = 18, BUILTIN_CLZL = 19, BUILTIN_CLZLL = 20, BUILTIN_IS_CONSTANT_EVALUATED = 21;

    static public IType intType = new CPPBasicType(Kind.eInt, 0);

    static public IType longType = new CPPBasicType(Kind.eInt, CPPBasicType.IS_LONG);

    static public IType longlongType = new CPPBasicType(Kind.eInt, CPPBasicType.IS_LONG_LONG);
	 ...
	 */
    private ICPPExecution executeBuiltinFfsCtz(ActivationRecord record, ConstexprEvaluationContext context, boolean isCtz, IType argType) {
    ...
    private ICPPExecution executeBuiltinFfs(ActivationRecord record, ConstexprEvaluationContext context, IType argType) {
        return executeBuiltinFfsCtz(record, context, false, /* ffs */
        argType);
    }

    private ICPPExecution executeBuiltinCtz(ActivationRecord record, ConstexprEvaluationContext context, IType argType) {
	 ...
	 */
    private ICPPExecution executeBuiltinPopcountParity(ActivationRecord record, ConstexprEvaluationContext context, boolean isParity, IType argType) {
        ICPPEvaluation arg0 = record.getVariable(new CPPBuiltinParameter(null, 0));
        IValue argValue = arg0.getValue();
        Number numberVal = argValue.numberValue();
        numberVal = Conversions.narrowNumberValue(numberVal, argType);
    ...
    private ICPPExecution executeBuiltinPopcount(ActivationRecord record, ConstexprEvaluationContext context, IType argType) {
        return executeBuiltinPopcountParity(record, context, false, argType);
    }

    private ICPPExecution executeBuiltinParity(ActivationRecord record, ConstexprEvaluationContext context, IType argType) {
	 ...
	 */
    private ICPPExecution executeBuiltinAbs(ActivationRecord record, ConstexprEvaluationContext context, IType argType) {
        ICPPEvaluation arg0 = record.getVariable(new CPPBuiltinParameter(null, 0));
        IValue argValue = arg0.getValue();
	 ...
	 */
    private ICPPExecution executeBuiltinClrsb(ActivationRecord record, ConstexprEvaluationContext context, IType argType) {
        ICPPEvaluation arg0 = record.getVariable(new CPPBuiltinParameter(null, 0));
        SizeAndAlignment sizeToType = SizeofCalculator.getSizeAndAlignment(argType);
        if (sizeToType.size > 8)
            // can't handle too-large type
            return null;
        IValue argValue = arg0.getValue();
        Number argNumber = argValue.numberValue();
        if (argNumber == null)
    ...
    private ICPPExecution executeBuiltinClz(ActivationRecord record, ConstexprEvaluationContext context, IType argType) {
        ICPPEvaluation arg0 = record.getVariable(new CPPBuiltinParameter(null, 0));
        SizeAndAlignment sizeToType = SizeofCalculator.getSizeAndAlignment(argType);
        if (sizeToType.size > 8)
            // can't handle too-large type
    ...
    private ICPPExecution executeBuiltinIsConstantEvaluated(ActivationRecord record, ConstexprEvaluationContext context, IType argType) {
