...
public class EvalConditional extends CPPDependentEvaluation {
    ...
    final public ICPPEvaluation fCondition, fPositive, fNegative;

    final public boolean fPositiveThrows, fNegativeThrows;

    public ValueCategory fValueCategory;

    public IType fType;

    public ICPPFunction fOverload;
    ...
    public boolean isValueDependent() {
        return fCondition.isValueDependent() || (fPositive != null && fPositive.isValueDependent()) || fNegative.isValueDependent();
    }
    ...
    private boolean computeIsConstantExpression() {
        return fCondition.isConstantExpression() && (fPositive == null || fPositive.isConstantExpression()) && fNegative.isConstantExpression();
    }
    ...
    public boolean isEquivalentTo(ICPPEvaluation other) {
        ...
        return fCondition.isEquivalentTo(o.fCondition) && areEquivalentOrNull(fPositive, o.fPositive) && fNegative.isEquivalentTo(o.fNegative);
    }
    ...
    private void evaluateInternal() {
        ...
        if (isClassType2 || isClassType3) {
            // sets fType and fValueCategory
            final Cost cost2 = convertToMatch(t2, vcat2, uqt2, t3, vcat3, uqt3);
            // sets fType and fValueCategory
            final Cost cost3 = convertToMatch(t3, vcat3, uqt3, t2, vcat2, uqt2);
    ...
    private Cost convertToMatch(IType t1, ValueCategory vcat1, IType uqt1, IType t2, ValueCategory vcat2, IType uqt2) {
        ...
        try {
            if (vcat2.isGLValue()) {
                ...
                Cost c = Conversions.checkImplicitConversionSequence(target, t1, vcat1, UDCMode.ALLOWED, Context.REQUIRE_DIRECT_BINDING, false);
                if (c.converts()) {
                    fType = t2;
                    fValueCategory = vcat2;
                    return c;
            ...
            Cost c = Conversions.checkImplicitConversionSequence(t2, t1, vcat1, UDCMode.ALLOWED, Context.ORDINARY, false);
            if (c.converts()) {
                fType = t2;
                fValueCategory = PRVALUE;
                return c;
    ...
    public ICPPEvaluation computeForFunctionCall(ActivationRecord record, ConstexprEvaluationContext context) {
        ...
        ICPPEvaluation positive = fPositive == null ? null : fPositive.computeForFunctionCall(record, context.recordStep());
