...
public class ExpressionWriter extends NodeWriter {
    ...
    //$NON-NLS-1$
    static final public String VECTORED_DELETE_OP = "[] ";

    //$NON-NLS-1$
    static final public String DELETE = "delete ";

    //$NON-NLS-1$
    static final public String STATIC_CAST_OP = "static_cast<";

    //$NON-NLS-1$
    static final public String REINTERPRET_CAST_OP = "reinterpret_cast<";

    //$NON-NLS-1$
    static final public String DYNAMIC_CAST_OP = "dynamic_cast<";
    ...
    //$NON-NLS-1$
    private static final String THREEWAYCOMPARISON_OP = " <=> ";
