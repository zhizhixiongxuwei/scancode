...
public abstract class PDOMLinkage extends PDOMNamedNode implements IIndexLinkage, IIndexBindingConstants {
    ...
    // Record offsets.
    static final public int ID_OFFSET = PDOMNamedNode.RECORD_SIZE + 0;

    static final public int NEXT_OFFSET = PDOMNamedNode.RECORD_SIZE + 4;

    static final public int INDEX_OFFSET = PDOMNamedNode.RECORD_SIZE + 8;

    static final public int NESTED_BINDINGS_INDEX = PDOMNamedNode.RECORD_SIZE + 12;

    static final public int MACRO_BTREE = PDOMNamedNode.RECORD_SIZE + 16;
    ...
    // No need for volatile, all fields of BTree are final.
