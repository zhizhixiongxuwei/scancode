...
public class CPPFunctionTemplate extends CPPTemplateDefinition implements ICPPFunctionTemplate, ICPPInternalFunction {
        ...
        if (declarator != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (binding instanceof ICPPParameter) {
                    ...
                    result[i] = new CPPParameter.CPPParameterProblem(param, IProblemBinding.SEMANTIC_INVALID_TYPE, pname.toCharArray());
                }
            }
    ...
    public ICPPFunctionType getDeclaredType() {
        if (declaredType == null) {
            ...
            while (parent.getParent() instanceof IASTDeclarator) parent = parent.getParent();
    ...
    public boolean hasStorageClass(int storage) {
        ...
        do {
            if (name != null) {
                IASTNode parent = name.getParent();
                while (parent != null && !(parent instanceof IASTDeclaration)) parent = parent.getParent();
