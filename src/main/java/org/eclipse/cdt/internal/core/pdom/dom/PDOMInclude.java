...
public class PDOMInclude implements IIndexFragmentInclude {
    ...
    static final public int INCLUDED_FILE = 0;

    static final public int INCLUDED_BY = 4;

    static final public int INCLUDES_NEXT = 8;

    static final public int INCLUDED_BY_NEXT = 12;

    static final public int INCLUDED_BY_PREV = 16;
    ...
    // TODO: assumes that int and stored pointers are the same size
