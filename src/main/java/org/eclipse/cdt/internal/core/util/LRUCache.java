...
public class LRUCache<K, T> implements Cloneable {
     ...
     */
    public int fCurrentSpace;

    /**
     * Maximum space allowed in cache
     */
    public int fSpaceLimit;

    /**
     * Counter for handing out sequential timestamps
     */
    public int fTimestampCounter;

    /**
     * Hash table for fast random access to cache entries
     */
    public Hashtable<K, LRUCacheEntry<K, T>> fEntryTable;

    /**
     * Start of queue (most recently used entry)
     */
    public LRUCacheEntry<K, T> fEntryQueue;
    ...
    protected String toStringContents() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            unsortedKeys[i] = key;
            unsortedToStrings[i] = (key instanceof org.eclipse.cdt.internal.core.model.CElement) ? ((org.eclipse.cdt.internal.core.model.CElement) key).getElementName() : key.toString();
        }
