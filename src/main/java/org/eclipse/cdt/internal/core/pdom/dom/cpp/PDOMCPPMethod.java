            ...
            if (parent instanceof ICPPASTQualifiedName) {
                ...
                if (parent instanceof IASTFunctionCallExpression) {
                    ...
                    if (fieldOwner.getValueCategory().isGLValue()) {
                        while (fieldOwner instanceof IASTUnaryExpression && ((IASTUnaryExpression) fieldOwner).getOperator() == IASTUnaryExpression.op_bracketedPrimary) fieldOwner = ((IASTUnaryExpression) fieldOwner).getOperand();
