...
public class CContainerInfo extends OpenableInfo {
    ...
    public Object[] nonCResources = null;
                        ...
                        case IResource.FOLDER:
                            {
                                ...
                                if (cproject.isOnSourceRoot(member) || isSourceEntry(resourcePath, entries) || (root == null && cproject.isOnOutputEntry(member))) {
                                    continue;
                                }
                                break;
                            }
                        case IResource.FILE:
                            {
                                ...
                                if (root != null && CoreModel.isValidTranslationUnitName(cproject.getProject(), filename) && root.isOnSourceEntry(member)) {
                                    continue;
                                }
