...
public class CProjectConverterDesciptor {
    ...
    //$NON-NLS-1$	//$NON-NLS-2$
    final static public String PROJECT_CONVERTER_EXTPOINT_ID = CCorePlugin.PLUGIN_ID + "." + "projectConverter";

    //$NON-NLS-1$
    final static public String CONVERTER = "converter";
    ...
    //$NON-NLS-1$
    final static public String OWNERS = "owners";
    ...
    private ICProjectConverter createConverter() throws CoreException {
        ...
        if (element != null) {
            ...
            if (obj instanceof ICProjectConverter) {
                ...
                SettingsModelMessages.getString("CProjectConverterDesciptor.0"));
        }
        //$NON-NLS-1$
