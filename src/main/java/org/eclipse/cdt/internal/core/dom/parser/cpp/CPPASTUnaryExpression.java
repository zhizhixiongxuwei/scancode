 ...
 *
 *  This program and the accompanying masterials
...
public class CPPASTUnaryExpression extends ASTNode implements ICPPASTUnaryExpression, IASTAmbiguityParent {
    ...
    public ICPPASTExpression fOperand;
    ...
    public CPPASTUnaryExpression copy(CopyStyle style) {
        CPPASTUnaryExpression copy = new CPPASTUnaryExpression(fOperator, fOperand == null ? null : fOperand.copy(style));
