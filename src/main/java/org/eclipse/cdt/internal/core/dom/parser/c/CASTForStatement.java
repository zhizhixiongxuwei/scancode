...
public class CASTForStatement extends ASTAttributeOwner implements IASTForStatement, IASTAmbiguityParent {
    ...
    public IASTExpression iterationExpression;

    public IASTStatement body;

    public IASTStatement init;

    public CASTForStatement() {
    }

    public CASTForStatement(IASTStatement init, IASTExpression condition, IASTExpression iterationExpression, IASTStatement body) {
