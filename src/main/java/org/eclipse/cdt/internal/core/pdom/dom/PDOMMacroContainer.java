...
public class PDOMMacroContainer extends PDOMNamedNode implements IIndexMacroContainer, IPDOMBinding {
    ...
    // size 4
    static final public int FIRST_DEF_OFFSET = PDOMNamedNode.RECORD_SIZE + 0;

    // size 4
    static final public int FIRST_REF_OFFSET = PDOMNamedNode.RECORD_SIZE + 4;

    @SuppressWarnings("hiding")
    static final public int RECORD_SIZE = PDOMNamedNode.RECORD_SIZE + 8;
