...
public class CRefSettingsHolder extends CExternalSettingsHolder {
     ...
     */
    //$NON-NLS-1$
    static final public String ATTR_FACTORY_ID = "factoryId";

    /**
     * Factory specific containerId used to resolve the settings container
     */
    //$NON-NLS-1$
    static final public String ATTR_CONTAINER_ID = "containerId";

    /**
     * The container we get settings from
     */
    final public CContainerRef fContainerRef;

    public boolean fIsReconsiled;
