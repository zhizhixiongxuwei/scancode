...
public class EvalID extends CPPDependentEvaluation {
    ...
    final public ICPPEvaluation fFieldOwner;

    final public char[] fName;

    final public IBinding fNameOwner;

    final public boolean fAddressOf;

    final public boolean fQualified;
    ...
    public EvalID(ICPPEvaluation fieldOwner, IBinding nameOwner, char[] simpleID, boolean addressOf, boolean qualified, boolean isPointerDeref, ICPPTemplateArgument[] templateArgs, IASTNode pointOfDefinition) {
        this(fieldOwner, nameOwner, simpleID, addressOf, qualified, isPointerDeref, templateArgs, findEnclosingTemplate(pointOfDefinition));
    }
    ...
    public boolean isEquivalentTo(ICPPEvaluation other) {
        ...
        return areEquivalentOrNull(fFieldOwner, o.fFieldOwner) && CharArrayUtils.equals(fName, o.fName) && fNameOwner == o.fNameOwner && fAddressOf == o.fAddressOf && fQualified == o.fQualified && fIsPointerDeref == o.fIsPointerDeref && areEquivalentArguments(fTemplateArgs, o.fTemplateArgs);
    }
    ...
    public static ICPPEvaluation create(IASTIdExpression expr) {
        ...
        if (binding instanceof ICPPTemplateNonTypeParameter) {
            // has to come before ICPPUnknownBinding
        ...
        if (binding instanceof ICPPUnknownBinding) {
            ...
            return new EvalID(fieldOwner, owner, name.getSimpleID(), isAddressOf(expr), name instanceof ICPPASTQualifiedName, false, templateArgs, expr);
        }
        /**
    ...
    public ICPPEvaluation instantiate(InstantiationContext context, int maxDepth) {
        ...
        if (!nameOwnerStillDependent && fieldOwner != null && !fieldOwner.isTypeDependent()) {
            ...
            if (fieldOwnerTypeSimplified instanceof ICPPClassType) {
                ICPPEvaluation eval = resolveName(name, (ICPPClassType) fieldOwnerTypeSimplified, fieldOwner, templateArgs, fieldOwnerTypeSimplifiedCV);
                if (eval != null)
                    return eval;
        ...
        return new EvalID(fieldOwner, nameOwner, name, fAddressOf, fQualified, fIsPointerDeref, templateArgs, getTemplateDefinition());
    }
    ...
    private ICPPEvaluation resolveName(char[] name, ICPPClassType nameOwner, ICPPEvaluation ownerEval, ICPPTemplateArgument[] templateArgs, IType impliedObjectType) {
        ...
        if (bindings.length != 0) {
            ...
            if (binding instanceof ICPPFunction) {
                ...
                return new EvalFunctionSet(new CPPFunctionSet(functions, templateArgs, null), fQualified, fAddressOf, impliedObjectType, getTemplateDefinition());
            }
            if (binding instanceof CPPFunctionSet) {
                return new EvalFunctionSet((CPPFunctionSet) binding, fQualified, fAddressOf, impliedObjectType, getTemplateDefinition());
            }
            if (binding instanceof IEnumerator) {
    ...
    public int determinePackSize(ICPPTemplateParameterMap tpMap) {
        ...
        if (fNameOwner instanceof ICPPUnknownBinding) {
            // handles template parameters as well
