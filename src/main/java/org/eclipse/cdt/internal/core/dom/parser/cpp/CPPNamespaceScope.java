...
public class CPPNamespaceScope extends CPPScope implements ICPPInternalNamespaceScope {
    ...
    static final public ICPPInternalNamespaceScope[] NO_NAMESPACE_SCOPES = {};

    public List<ICPPUsingDirective> fUsingDirectives;

    public boolean fIsInline;

    public boolean fIsInlineInitialized;

    public ICPPNamespaceScope[] fEnclosingNamespaceSet;
        ...
        try {
            for (int i = segments.length; --i >= 0; ) {
                ...
                if (segments[i] instanceof IASTName) {
                    ...
                    if (segmentBinding instanceof ICPPTemplateInstance || !CharArrayUtils.equals(scopeName.getSimpleID(), segmentBinding.getNameCharArray())) {
                        return false;
                    }
                }
