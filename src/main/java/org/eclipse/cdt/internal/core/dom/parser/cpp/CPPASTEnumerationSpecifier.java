...
public class CPPASTEnumerationSpecifier extends CPPASTBaseDeclSpecifier implements IASTInternalEnumerationSpecifier, ICPPASTEnumerationSpecifier {
    ...
    public ScopeStyle fScopeStyle;

    public boolean fIsOpaque;

    public IASTName fName;

    public ICPPASTDeclSpecifier fBaseType;
    ...
    public CPPASTEnumerationSpecifier copy(CopyStyle style) {
        CPPASTEnumerationSpecifier copy = new CPPASTEnumerationSpecifier(fScopeStyle, fName == null ? null : fName.copy(style), fBaseType == null ? null : fBaseType.copy(style));
