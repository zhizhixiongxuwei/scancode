...
public class PDOMCPPFieldTemplate extends PDOMCPPVariableTemplate implements ICPPFieldTemplate {
    ...
    // 2 bytes 1-based
    static final public int FIELD_POSITION_OFFSET = PDOMCPPVariableTemplate.RECORD_SIZE;

    @SuppressWarnings("hiding")
    static final public int RECORD_SIZE = FIELD_POSITION_OFFSET + 2;

    public PDOMCPPFieldTemplate(PDOMCPPLinkage linkage, PDOMNode parent, ICPPFieldTemplate template) throws CoreException, DOMException {
