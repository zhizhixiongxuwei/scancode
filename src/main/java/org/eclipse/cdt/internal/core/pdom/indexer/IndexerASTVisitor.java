...
abstract public class IndexerASTVisitor extends ASTVisitor {
    ...
    public static class Definition {
        ...
        // The AST node for the entire definition.
        IASTNode fNode;

        // Definitions contained within this one.
    ...
    public IASTName fDefinitionName;

    public IASTNode fDefinitionNode;

    public ArrayList<Definition> fStack = new ArrayList<>();

    public ArrayList<IASTProblem> fProblems = new ArrayList<>();
