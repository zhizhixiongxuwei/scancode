...
public class CompositeCEnumeration extends CompositeCBinding implements IEnumeration, IIndexType {
    ...
    public IEnumerator[] getEnumerators() {
        ...
        for (int i = 0; i < result.length; i++) result[i] = (IEnumerator) cf.getCompositeBinding((IIndexFragmentBinding) result[i]);
        return result;
    }
