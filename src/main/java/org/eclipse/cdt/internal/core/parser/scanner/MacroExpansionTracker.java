...
public class MacroExpansionTracker {
    ...
    final public int fStepToTrack;

    public int fStepCount;

    public String fPreStep;

    public ReplaceEdit fReplacement;

    public IMacroBinding fMacroDefinition;
    ...
    void fail() {
        ...
        //$NON-NLS-1$
        fReplacement = new ReplaceEdit(0, 0, "");
    }
