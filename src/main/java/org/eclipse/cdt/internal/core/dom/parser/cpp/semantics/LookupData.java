...
public class LookupData extends ScopeLookupData {
    ...
    static final public ICPPTemplateArgument[] UNINITIALIZED_TEMPLATE_ARGUMENTS = {};
    ...
    public LookupData(IASTName name) {
        ...
        // Lazy initialization to avoid DOMException.
        fTemplateArguments = UNINITIALIZED_TEMPLATE_ARGUMENTS;
        configureWith(name);
    }
    ...
    private void configureWith(final IASTName name) {
        ...
        if (nameParent instanceof ICPPASTBaseSpecifier || nameParent instanceof ICPPASTElaboratedTypeSpecifier || nameParent instanceof ICPPASTCompositeTypeSpecifier) {
            typesOnly = true;
    ...
    public static boolean checkWholeClassScope(IASTName name) {
        ...
        if (nameProp == IASTIdExpression.ID_NAME || nameProp == IASTFieldReference.FIELD_NAME || nameProp == ICASTFieldDesignator.FIELD_NAME || nameProp == ICPPASTFieldDesignator.FIELD_NAME || nameProp == ICPPASTUsingDirective.QUALIFIED_NAME || nameProp == ICPPASTUsingDeclaration.NAME || nameProp == IASTFunctionCallExpression.FUNCTION_NAME || nameProp == IASTNamedTypeSpecifier.NAME || nameProp == ICPPASTConstructorChainInitializer.MEMBER_ID) {
        ...
        for (; node != null; node = node.getParent()) {
            ...
            if (node instanceof IASTInitializerList || node instanceof IASTEqualsInitializer) {
                if (node.getPropertyInParent() == IASTDeclarator.INITIALIZER) {
                    ...
                    if (decl instanceof IASTSimpleDeclaration && decl.getPropertyInParent() == IASTCompositeTypeSpecifier.MEMBER_DECLARATION) {
    ...
    public static boolean typesOnly(IASTName tn) {
        ...
        IASTNode parent = tn.getParent();
        if (parent instanceof ICPPASTBaseSpecifier || parent instanceof ICPPASTElaboratedTypeSpecifier || parent instanceof ICPPASTCompositeTypeSpecifier) {
            return true;
