...
public class PDOMCPPClassTemplateSpecialization extends PDOMCPPClassSpecialization implements ICPPClassTemplate, ICPPInstanceCache {
    ...
    public PDOMCPPClassTemplateSpecialization(PDOMCPPLinkage linkage, PDOMNode parent, ICPPClassTemplate template, PDOMBinding specialized) throws CoreException {
        ...
        // sets fTemplateParameters
        computeTemplateParameters(template);
    ...
    public boolean isSameType(IType type) {
        ...
        if (type instanceof ICPPClassSpecialization == false || type instanceof ICPPTemplateDefinition == false || type instanceof IProblemBinding)
            return false;
    ...
    private void computeTemplateParameters(ICPPClassTemplate originalTemplate) {
        try {
            fTemplateParameters = PDOMTemplateParameterArray.createPDOMTemplateParameters(getLinkage(), this, originalTemplate.getTemplateParameters());
