...
public class CASTCompositeTypeSpecifier extends CASTBaseDeclSpecifier implements ICASTCompositeTypeSpecifier {
    ...
    public IASTDeclaration[] fActiveDeclarations;

    public IASTDeclaration[] fAllDeclarations;

    public int fDeclarationsPos = -1;
    ...
    public void addMemberDeclaration(IASTDeclaration declaration) {
        ...
        if (declaration != null) {
            ...
            fAllDeclarations = ArrayUtil.appendAt(IASTDeclaration.class, fAllDeclarations, ++fDeclarationsPos, declaration);
