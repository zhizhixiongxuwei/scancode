...
public abstract class MultiOperation extends CModelOperation {
     ...
     */
    public String[] fRenamingsList = null;
     ...
     */
    public Map<ICElement, ICElement> fParentElements;
     ...
     * @see #processElements()
     */
    public Map<ICElement, ICElement> fInsertBeforeElements = new HashMap<>(1);

    /**
     * This table presents the data in <code>fRenamingList</code> in a more
     * convenient way.
     */
    public Map<ICElement, String> fRenamings;
    ...
    protected MultiOperation(ICElement[] elementsToProcess, ICElement[] parentElements, boolean force) {
        ...
        if (elementsToProcess.length == parentElements.length) {
            ...
            //same destination for all elements to be moved/copied/renamed
