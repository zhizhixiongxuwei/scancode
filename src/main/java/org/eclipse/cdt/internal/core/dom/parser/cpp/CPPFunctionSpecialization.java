 ...
 */
public class CPPFunctionSpecialization extends CPPSpecialization implements ICPPFunctionSpecialization, ICPPInternalFunction {

    final public ICPPFunctionType fType;

    public ICPPParameter[] fParams;

    final public IType[] fExceptionSpecs;
    ...
    public boolean isInline() {
        if (getDefinition() != null) {
            ...
            while (!(def instanceof IASTFunctionDefinition)) def = def.getParent();
