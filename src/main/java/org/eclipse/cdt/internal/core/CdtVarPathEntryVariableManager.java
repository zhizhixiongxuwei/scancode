...
public class CdtVarPathEntryVariableManager implements IPathEntryVariableManager, ICdtVariableChangeListener {
    ...
    public UserDefinedVariableSupplier fUserVarSupplier = UserDefinedVariableSupplier.getInstance();

    public VarSubstitutor fSubstitutor = new VarSubstitutor();

    public VarSupplier fVarSupplier = new VarSupplier();

    public Set<IPathEntryVariableChangeListener> fListeners;
