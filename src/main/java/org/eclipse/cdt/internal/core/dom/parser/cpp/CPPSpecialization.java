...
public abstract class CPPSpecialization extends PlatformObject implements ICPPSpecialization, ICPPInternalBinding {
    ...
    final public IBinding owner;

    final public IBinding specialized;

    final public ICPPTemplateParameterMap argumentMap;

    public IASTNode definition;

    public IASTNode[] declarations;
