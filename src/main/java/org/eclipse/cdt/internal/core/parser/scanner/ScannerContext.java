 ...
 * @since 5.0
 */
final public class ScannerContext {
    ...
    public ScannerContext(ILocationCtx ctx, ScannerContext parent, TokenList tokens) {
        ...
        // no branches in result of macro expansion
        fInactiveState = CodeState.eSkipInactive;
    }
