...
public class EvalInitList extends CPPDependentEvaluation {
    ...
    final public ICPPEvaluation[] fClauses;

    public boolean fCheckedIsValueDependent;

    public boolean fIsValueDependent;

    public boolean fCheckedIsConstantExpression;

    public boolean fIsConstantExpression;
