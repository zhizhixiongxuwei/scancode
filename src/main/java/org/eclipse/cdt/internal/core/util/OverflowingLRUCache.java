...
public abstract class OverflowingLRUCache<K, T> extends LRUCache<K, T> {
    ...
    public Enumeration<T> elements() {
        ...
        LRUCacheEnumerator.LRUEnumeratorElement<T> head = new LRUCacheEnumerator.LRUEnumeratorElement<>(fEntryQueue._fValue);
