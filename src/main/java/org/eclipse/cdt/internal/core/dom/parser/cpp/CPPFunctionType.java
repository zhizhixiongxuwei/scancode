...
public class CPPFunctionType implements ICPPFunctionType, ISerializableType {
    ...
    final public boolean hasRefQualifier;
    ...
    public CPPFunctionType(IType returnType, IType[] types, ICPPEvaluation noexceptSpecifier, boolean isConst, boolean isVolatile, boolean hasRefQualifier, boolean isRValueReference, boolean takesVarargs) {
    ...
    public boolean isSameType(IType o) {
        ...
        if (o instanceof ICPPFunctionType) {
            ...
            if (isConst() != ft.isConst() || isVolatile() != ft.isVolatile() || hasRefQualifier() != ft.hasRefQualifier() || isRValueReference() != ft.isRValueReference() || takesVarArgs() != ft.takesVarArgs()) {
                return false;
            }
            IType[] fps;
    ...
    public static IType unmarshal(short firstBytes, ITypeMarshalBuffer buffer) throws CoreException {
        ...
        return new CPPFunctionType(rt, pars, noexcept, isConst, isVolatile, hasRefQualifier, isRValueReference, takesVarargs);
    }
