...
public class CFolderDescription extends CDataProxyContainer implements ICFolderDescription, IProxyFactory, IInternalResourceDescription {
    ...
    public PathSettingsContainer fCache;
    ...
    public ICLanguageSetting createLanguageSettingForContentTypes(String languageId, String[] typeIds) throws CoreException {
        ...
        if (!(proxy instanceof ICLanguageSetting))
            ...
            SettingsModelMessages.getString("CFolderDescription.1") + proxy.getClass().getName());
    ...
    public ICLanguageSetting createLanguageSettingForExtensions(String languageId, String[] extensions) throws CoreException {
        ...
        if (!(proxy instanceof ICLanguageSetting))
            throw ExceptionFactory.createCoreException(//$NON-NLS-1$
            SettingsModelMessages.getString("CFolderDescription.3") + proxy.getClass().getName());
        return (ICLanguageSetting) proxy;
    }
