...
public class TaggerDescriptor {
    ...
    //$NON-NLS-1$
    static final public String Attr_LocalId = "local-id";
    ...
    public String getId() {
        ...
        if (localId == null) {
            ...
            "Invalid extension " + globalId + '.' + extId + //$NON-NLS-1$
            " must provide tagger's local-id");
            return null;
        }
        ...
        if (localId.isEmpty()) {
            ...
            CCorePlugin.log(//$NON-NLS-1$
            "Invalid extension " + globalId + '.' + extId + //$NON-NLS-1$
            " must provide value for tagger's local-id");
            return null;
        }
