...
public class ResourceDescriptionHolder {
    ...
    public PathSettingsContainer fPathSettingContainer;

    public boolean fIncludeCurrent;
    ...
    public ICResourceDescription[] getResourceDescriptions(final int kind) {
        ...
        fPathSettingContainer.accept(new IPathSettingsContainerVisitor() {
            ...
            public boolean visit(PathSettingsContainer container) {
                ...
                if ((container != fPathSettingContainer || fIncludeCurrent) && des != null && (kind & des.getType()) == des.getType()) {
                    list.add(des);
                }
                return true;
            }
