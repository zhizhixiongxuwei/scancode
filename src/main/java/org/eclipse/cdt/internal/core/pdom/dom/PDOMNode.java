...
public abstract class PDOMNode implements IInternalPDOMNode {
    ...
    static final public int FACTORY_ID = 0;

    static final public int NODE_TYPE = FACTORY_ID + 2;

    static final public int PARENT = NODE_TYPE + 2;

    static final public int RECORD_SIZE = PARENT + Database.PTR_SIZE;
