 ...
 */
public abstract class CPPTemplateParameterSpecialization extends PlatformObject implements ICPPTemplateParameter, ICPPSpecialization, ICPPUnknownBinding {

    final public ICPPSpecialization fOwner;

    final public ICPPScope fScope;

    final public ICPPTemplateParameter fSpecialized;

    final public ICPPTemplateParameterMap fTemplateParameterMap;

    final public ICPPTemplateArgument fDefaultValue;

    public CPPTemplateParameterSpecialization(ICPPSpecialization owner, ICPPScope scope, ICPPTemplateParameter specialized, ICPPTemplateArgument defaultValue) {
        fOwner = owner;
        fScope = scope;
