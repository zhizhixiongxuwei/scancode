...
public class ASTWriter {
    ...
    final public ASTModificationStore modificationStore = new ASTModificationStore();
    ...
    public String write(IASTNode rootNode, NodeCommentMap commentMap) throws ProblemRuntimeException {
        ChangeGeneratorWriterVisitor writer = new ChangeGeneratorWriterVisitor(modificationStore, null, commentMap, ConstPlacement.placeConstRight(rootNode));
        if (rootNode != null) {
