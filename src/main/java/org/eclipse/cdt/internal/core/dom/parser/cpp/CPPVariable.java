...
public class CPPVariable extends PlatformObject implements ICPPInternalDeclaredVariable {
    ...
    public IASTName fDefinition;

    // Allowed to have trailing nulls. Users must check or trim!
    public IASTName[] fDeclarations;
    ...
    private IValue computeInitialValue() {
        ...
        try {
            ...
            if (nestedType instanceof ICPPClassType || (initialValue = VariableHelpers.getInitialValue(fDefinition, fDeclarations, getType())) == IntegralValue.UNKNOWN || getStructuredBindingDeclaration() != null) {
    ...
    private ICPPEvaluation evaluationOfStructuredBindingInitializer(ICPPASTStructuredBindingDeclaration structuredBinding) {
