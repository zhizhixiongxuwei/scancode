...
public class TemplateParameterWriter extends NodeWriter {
    ...
    //$NON-NLS-1$
    static final public String TEMPLATE_LESS_THAN = "template <";
    ...
    protected void writeTemplateParameter(ICPPASTTemplateParameter parameter) {
        if (parameter instanceof ICPPASTParameterDeclaration) {
            ...
            writeTemplateParameter(simple.getParameterType() == ICPPASTSimpleTypeTemplateParameter.st_class, simple.isParameterPack(), simple.getName(), simple.getDefaultType());
    ...
    private void writeTemplatedTypeTemplateParameter(ICPPASTTemplatedTypeTemplateParameter templated) {
        ...
        scribe.printSpace();
        writeTemplateParameter(templated.getParameterType() == ICPPASTTemplatedTypeTemplateParameter.tt_class, templated.isParameterPack(), templated.getName(), templated.getDefaultValue());
    }
