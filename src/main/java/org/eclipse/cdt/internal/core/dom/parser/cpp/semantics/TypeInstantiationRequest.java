...
public class TypeInstantiationRequest {
    ...
    final public ICPPTemplateParameterMap parameterMap;

    final public int packOffset;

    final public ICPPTypeSpecialization contextTypeSpecialization;
    ...
    public TypeInstantiationRequest(IType type, InstantiationContext context) {
		 ...
		 */
        this.parameterMap = context.isForDeduction() ? new CPPTemplateParameterMap((CPPTemplateParameterMap) context.getParameterMap()) : context.getParameterMap();
