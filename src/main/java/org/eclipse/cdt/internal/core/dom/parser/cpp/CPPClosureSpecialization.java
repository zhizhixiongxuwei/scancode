...
public class CPPClosureSpecialization extends CPPClosureType implements ICPPClassSpecialization {
    ...
    public CPPClosureType fSpecialized;

    public ICPPTemplateParameterMap fMap;

    public CPPClosureSpecialization(ICPPASTLambdaExpression lambda, CPPClosureType specialized, InstantiationContext context) {
        super(lambda);
