...
public class ExecStaticAssert implements ICPPExecution {
    ...
    public static final ICPPEvaluation FAILED = new EvalFixed(ProblemType.STATIC_ASSERT_FAILED, PRVALUE, IntegralValue.STATIC_ASSERT_FAILED_ERROR);

    public static final ExecStaticAssert FAILED_INSTANCE = new ExecStaticAssert(null);

    final public ICPPEvaluation fCondition;
