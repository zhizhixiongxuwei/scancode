...
public class CodeReaderFactoryAdapter extends AbstractCodeReaderFactory {
    ...
    public InternalFileContentProvider fDelegate;
    ...
    @Override
    public org.eclipse.cdt.core.parser.CodeReader createCodeReaderForInclusion(IIndexFileLocation ifl, String astPath) throws CoreException, IOException {
