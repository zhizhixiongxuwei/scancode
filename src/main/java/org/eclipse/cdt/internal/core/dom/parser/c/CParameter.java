...
public class CParameter extends PlatformObject implements IParameter {
    ...
    public IScope getScope() {
        ...
        for (IASTName declaration : declarations) {
            if (declaration == null)
                // Skip nulls at the end of the declarations array
                break;
    ...
    public boolean hasStorageClass(int storage) {
        ...
        for (int i = 0; i < declarations.length && declarations[i] != null; i++) {
            ...
            while (!(parent instanceof IASTParameterDeclaration) && !(parent instanceof IASTDeclaration)) parent = parent.getParent();
