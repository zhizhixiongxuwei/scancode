...
public class CConfigurationDataProviderDescriptor {
    ...
    //$NON-NLS-1$	//$NON-NLS-2$
    final static public String DATA_PROVIDER_EXTPOINT_ID = CCorePlugin.PLUGIN_ID + "." + "CConfigurationDataProvider";

    //$NON-NLS-1$
    final static public String DATA_PROVIDER = "provider";

    //$NON-NLS-1$
    final static public String CLASS = "class";

    //$NON-NLS-1$
    final static public String NATURES = "natures";

    //$NON-NLS-1$
    final static public String CONFLICTING_NATURES = "conflictingNatures";

    //$NON-NLS-1$
    final static String ECLIPSE_BUILDERS = "eclipseBuilders";
        ...
        for (int i = 0; i < elements.length; i++) {
            ...
            if (DATA_PROVIDER.equals(element.getName())) {
                ...
                if (obj instanceof CConfigurationDataProvider) {
                    ...
                    SettingsModelMessages.getString("CConfigurationDataProviderDescriptor.1"));
            }
        }
        throw ExceptionFactory.createCoreException(//$NON-NLS-1$
        SettingsModelMessages.getString("CConfigurationDataProviderDescriptor.2"));
    }
