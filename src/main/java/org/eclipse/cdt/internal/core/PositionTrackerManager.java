...
public class PositionTrackerManager implements IPositionTrackerManager, IFileBufferListener {
    ...
    static final public int HASHMAP_ENTRY_SIZE = 56;

    // 512 kbytes
    static final public int MAX_MEMORY = 1024 * 512;

    // 70% of MAX_MEMORY
    static final public int MAX_MEMORY_AFTER_CLEANUP = (MAX_MEMORY * 7) / 10;

    static public PositionTrackerManager sManager = new PositionTrackerManager();

    public static PositionTrackerManager getInstance() {
        return sManager;
    }

    public int fMemoryCounter = 0;
