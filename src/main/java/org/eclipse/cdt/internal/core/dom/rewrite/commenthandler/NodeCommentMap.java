...
public class NodeCommentMap {
    ...
    final public Map<IASTNode, List<IASTComment>> leadingMap = new HashMap<>();

    final public Map<IASTNode, List<IASTComment>> trailingMap = new HashMap<>();

    final public Map<IASTNode, List<IASTComment>> freestandingMap = new HashMap<>();

    final public List<IASTTranslationUnit> coveredUnits = new ArrayList<>();
