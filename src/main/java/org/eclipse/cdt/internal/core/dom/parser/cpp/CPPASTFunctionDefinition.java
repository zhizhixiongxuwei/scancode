 ...
 */
public class CPPASTFunctionDefinition extends CPPASTAttributeOwner implements ICPPASTFunctionDefinition, IASTImplicitNameOwner {

    public IASTDeclSpecifier declSpecifier;

    public IASTFunctionDeclarator declarator;

    public IASTStatement bodyStatement;

    public ICPPASTConstructorChainInitializer[] memInits;

    // for constructors: base constructors called implicitly
    public IASTImplicitName[] implicitNames;
