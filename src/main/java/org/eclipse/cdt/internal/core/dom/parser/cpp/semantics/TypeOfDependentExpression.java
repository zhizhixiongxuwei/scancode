...
public class TypeOfDependentExpression extends CPPUnknownBinding implements ICPPUnknownType, ISerializableType {
    ...
    public boolean fIsForDecltype;

    public boolean fIsForTemplateAuto;
    ...
    public boolean isSameType(IType type) {
        return type instanceof TypeOfDependentExpression && fEvaluation.isEquivalentTo(((TypeOfDependentExpression) type).fEvaluation);
    }
