...
public class PDOMCPPVariableTemplatePartialSpecialization extends PDOMCPPVariableTemplate implements ICPPVariableTemplatePartialSpecialization, IPDOMPartialSpecialization, IPDOMOverloader {
    ...
    static final public int ARGUMENTS = PDOMCPPVariableTemplate.RECORD_SIZE + 0;

    static final public int SIGNATURE_HASH = ARGUMENTS + Database.PTR_SIZE;

    static final public int PRIMARY = SIGNATURE_HASH + Database.INT_SIZE;

    static final public int NEXT_PARTIAL = PRIMARY + Database.PTR_SIZE;

    @SuppressWarnings("hiding")
    static final public int RECORD_SIZE = NEXT_PARTIAL + Database.PTR_SIZE;

    public PDOMCPPVariableTemplatePartialSpecialization(PDOMCPPLinkage linkage, PDOMNode parent, ICPPVariableTemplatePartialSpecialization parSpec, PDOMCPPVariableTemplate primary) throws CoreException, DOMException {
