...
public class CPPASTTryBlockStatement extends CPPASTAttributeOwner implements ICPPASTTryBlockStatement {
    ...
    public ICPPASTCatchHandler[] catchHandlers;

    public int catchHandlersPos = -1;

    public IASTStatement tryBody;
    ...
    public CPPASTTryBlockStatement copy(CopyStyle style) {
        ...
        for (ICPPASTCatchHandler handler : getCatchHandlers()) copy.addCatchHandler(handler == null ? null : handler.copy(style));
