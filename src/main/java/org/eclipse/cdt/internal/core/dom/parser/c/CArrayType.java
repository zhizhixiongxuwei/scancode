...
public class CArrayType implements ICArrayType, ITypeContainer, ISerializableType {
    ...
    public IASTExpression sizeExpression;

    public IValue value = IntegralValue.NOT_INITIALIZED;
    ...
    public static IType unmarshal(short firstBytes, ITypeMarshalBuffer buffer) throws CoreException {
        ...
        CArrayType result = new CArrayType(nested, (firstBytes & ITypeMarshalBuffer.FLAG1) != 0, (firstBytes & ITypeMarshalBuffer.FLAG2) != 0, (firstBytes & ITypeMarshalBuffer.FLAG3) != 0, value);
