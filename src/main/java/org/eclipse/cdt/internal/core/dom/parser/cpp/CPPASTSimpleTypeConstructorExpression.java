...
public class CPPASTSimpleTypeConstructorExpression extends ASTNode implements ICPPASTSimpleTypeConstructorExpression, IASTImplicitNameOwner {

    public ICPPASTDeclSpecifier fDeclSpec;

    public IASTInitializer fInitializer;

    public ICPPEvaluation fEvaluation;

    public IASTImplicitDestructorName[] fImplicitDestructorNames;
    ...
    public ICPPEvaluation getEvaluation() {
        if (fEvaluation == null) {
            ...
            if (fInitializer instanceof ICPPASTConstructorInitializer || fInitializer instanceof ICPPASTInitializerList) {
                ...
                fEvaluation = new EvalTypeId(type, this, usesBracedInitList, EvalConstructor.extractArguments(fInitializer));
            } else {
