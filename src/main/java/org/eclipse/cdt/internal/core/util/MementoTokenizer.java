...
public class MementoTokenizer {
    ...
    static final public String CPROJECT = Character.toString(CElement.CEM_CPROJECT);

    static final public String SOURCEROOT = Character.toString(CElement.CEM_SOURCEROOT);

    static final public String SOURCEFOLDER = Character.toString(CElement.CEM_SOURCEFOLDER);

    static final public String TRANSLATIONUNIT = Character.toString(CElement.CEM_TRANSLATIONUNIT);

    static final public String SOURCEELEMENT = Character.toString(CElement.CEM_SOURCEELEMENT);
