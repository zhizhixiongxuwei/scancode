...
public class CModelListener implements IElementChangedListener, IResourceChangeListener {
    ...
    static final public int UPDATE_LR_CHANGED_FILES_COUNT = 5;
    ...
    final public LinkedHashMap<ITranslationUnit, ITranslationUnit> fLRUs = new LinkedHashMap<>(UPDATE_LR_CHANGED_FILES_COUNT, 0.75f, true) {
