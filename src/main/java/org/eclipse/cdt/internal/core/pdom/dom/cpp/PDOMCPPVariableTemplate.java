...
public class PDOMCPPVariableTemplate extends PDOMCPPVariable implements ICPPVariableTemplate, ICPPInstanceCache, IPDOMCPPTemplateParameterOwner {
    ...
    static final public int TEMPLATE_PARAMS = PDOMCPPVariable.RECORD_SIZE;

    static final public int FIRST_PARTIAL = TEMPLATE_PARAMS + Database.PTR_SIZE;

    @SuppressWarnings("hiding")
    static final public int RECORD_SIZE = FIRST_PARTIAL + Database.PTR_SIZE;

    volatile public IPDOMCPPTemplateParameter[] params;

    public PDOMCPPVariableTemplate(PDOMCPPLinkage linkage, PDOMNode parent, ICPPVariableTemplate template) throws CoreException, DOMException {
    ...
    public ICPPPartialSpecialization[] getPartialSpecializations() {
        try {
            ...
            for (PDOMCPPVariableTemplatePartialSpecialization partial = getFirstPartial(); partial != null; partial = partial.getNextPartial()) {
