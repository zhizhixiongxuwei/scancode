...
public class CNodeFactory extends NodeFactory implements ICNodeFactory {
    ...
    static final public CNodeFactory DEFAULT_INSTANCE = new CNodeFactory();
    ...
    @Override
    public IASTForStatement newForStatement(IASTStatement init, IASTExpression condition, IASTExpression iterationExpression, IASTStatement body) {
    ...
    @Override
    public IASTFunctionDefinition newFunctionDefinition(IASTDeclSpecifier declSpecifier, IASTFunctionDeclarator declarator, IASTStatement bodyStatement) {
