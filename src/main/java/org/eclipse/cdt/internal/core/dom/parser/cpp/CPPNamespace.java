...
public class CPPNamespace extends PlatformObject implements ICPPNamespace, ICPPInternalBinding {
    ...
    public IASTName[] namespaceDefinitions;

    public ICPPNamespaceScope scope;

    public ICPPASTTranslationUnit tu;
    ...
    static private class NamespaceMemberCollector extends ASTVisitor {
        ...
        public int visit(IASTDeclarator declarator) {
            while (declarator.getNestedDeclarator() != null) declarator = declarator.getNestedDeclarator();
