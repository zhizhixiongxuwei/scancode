...
public class CPPTemplateTypeParameterSpecialization extends CPPTemplateParameterSpecialization implements ICPPTemplateTypeParameter {
    ...
    public CPPTemplateTypeParameterSpecialization(ICPPSpecialization owner, ICPPScope scope, ICPPTemplateTypeParameter specialized, ICPPTemplateArgument defaultValue) {
