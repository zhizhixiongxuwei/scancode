...
public class Buffer implements IBuffer {
    ...
    public ArrayList<IBufferChangedListener> changeListeners;
            ...
            for (int i = 0, size = this.changeListeners.size(); i < size; ++i) {
                ...
                SafeRunner.run(new ISafeRunnable() {
                    ...
                    public void handleException(Throwable exception) {
                        ...
                        log(//$NON-NLS-1$
                        exception, //$NON-NLS-1$
                        "Exception occurred in listener of buffer change notification", ICLogConstants.CDT);
                    }
    ...
    public String toString() {
        ...
        //$NON-NLS-1$
        buffer.append("Owner: ").append(((CElement) this.owner).toString());
        //$NON-NLS-1$
