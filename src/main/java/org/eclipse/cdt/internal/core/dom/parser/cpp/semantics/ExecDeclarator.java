...
public final class ExecDeclarator implements ICPPExecution {
    ...
    final public ICPPBinding declaredBinding;

    final public ICPPEvaluation initializerEval;
    ...
    private ICPPEvaluation createInitialValue(IType type, ActivationRecord record, ConstexprEvaluationContext context) {
        ...
        if (isValueInitialization(computedInitializerEval)) {
            ICPPEvaluation defaultValue = new EvalTypeId(type, computedInitializerEval.getTemplateDefinition(), false, false, ICPPEvaluation.EMPTY_ARRAY);
    ...
    private ICPPEvaluation createReferenceValue(ActivationRecord record, ConstexprEvaluationContext context, ICPPEvaluation computedInitializerEval) {
        ...
        if (initValue instanceof EvalBinary && computedInitializerEval instanceof EvalCompositeAccess)
            return createReferenceFromCompositeAccess(record, templateDefinition, (EvalCompositeAccess) computedInitializerEval);
        return EvalFixed.INCOMPLETE;
    }
    ...
    public ICPPExecution instantiate(InstantiationContext context, int maxDepth) {
        ...
        ICPPEvaluation newInitializerEval = initializerEval == null ? null : initializerEval.instantiate(context, maxDepth);
