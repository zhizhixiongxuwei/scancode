...
public class Include extends SourceManipulation implements IInclude {
    ...
    final public boolean standard;

    public boolean fIsResolved = true;
    ...
    public static boolean equals(IInclude lhs, IInclude rhs) {
        return CElement.equals(lhs, rhs) && lhs.isActive() == rhs.isActive() && lhs.isResolved() == rhs.isResolved() && lhs.isLocal() == rhs.isLocal() && (lhs.getFullFileName() == rhs.getFullFileName() || lhs.getFullFileName() != null && lhs.getFullFileName().equals(rhs.getFullFileName()));
    }
}
