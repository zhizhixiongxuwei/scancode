...
public class ModifiedASTDeclSpecWriter extends DeclSpecWriter {
    ...
    public ModifiedASTDeclSpecWriter(Scribe scribe, ASTWriterVisitor visitor, ModificationScopeStack stack, NodeCommentMap commentMap, boolean placeConstRight) {
