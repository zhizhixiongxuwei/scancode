...
public class ChangeGenerator extends ASTVisitor {
    ...
    final public Map<IASTNode, Map<ModificationKind, List<ASTModification>>> classifiedModifications = new HashMap<>();

    public int processedOffset;

    public MultiTextEdit rootEdit;

    public CompositeChange change;
