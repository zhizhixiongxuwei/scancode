...
public class CPPASTFunctionCallExpression extends ASTNode implements ICPPASTFunctionCallExpression, IASTAmbiguityParent {
    ...
    public ICPPASTExpression fFunctionName;

    public IASTInitializerClause[] fArguments;
                    ...
                    if (t instanceof ICPPClassType && !(t instanceof ICPPUnknownBinding)) {
                        ...
                        try {
                            ...
                            if (b instanceof IProblemBinding && !(b instanceof ICPPFunction))
                                b = new CPPFunction.CPPFunctionProblem(data.getLookupName(), ((IProblemBinding) b).getID());
