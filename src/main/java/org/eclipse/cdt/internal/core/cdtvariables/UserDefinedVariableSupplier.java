...
public class UserDefinedVariableSupplier extends CoreMacroSupplierBase {
    ...
    //$NON-NLS-1$
    static final public String OLD_VARIABLE_PREFIX = "pathEntryVariable.";

    static public UserDefinedVariableSupplier fInstance;

    public StorableCdtVariables fWorkspaceMacros;
