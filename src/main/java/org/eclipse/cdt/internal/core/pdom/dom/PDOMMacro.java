...
public class PDOMMacro implements IIndexMacro, IPDOMBinding {
    ...
    static final public int CONTAINER = 0;

    static final public int FILE = 4;

    static final public int PARAMETERS = 8;

    static final public int EXPANSION = 12;

    static final public int NEXT_IN_FILE = 16;
