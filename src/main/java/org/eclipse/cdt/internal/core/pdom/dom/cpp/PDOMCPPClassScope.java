...
public class PDOMCPPClassScope implements ICPPClassScope, IIndexScope {
    ...
    public IBinding[] getBindings(ScopeLookupData lookup) {
        try {
            ...
            // Prefix lookup.
            BindingCollector visitor = new BindingCollector(fBinding.getLinkage(), nameChars, IndexFilter.CPP_DECLARED_OR_IMPLICIT_NO_INSTANCE, true, true, false);
    ...
    public static void updateCache(IPDOMCPPClassType ct, PDOMNode member) throws CoreException {
        if (member instanceof PDOMBinding) {
            ...
            Reference<CharArrayObjectMap<List<PDOMBinding>>> cached = (Reference<CharArrayObjectMap<List<PDOMBinding>>>) pdom.getCachedResult(key);
