...
public abstract class ImageLocationInfo {
    ...
    public int fTokenOffsetInExpansion = -1;
    ...
    public static class MacroImageLocationInfo extends ImageLocationInfo {
        ...
        public IASTImageLocation createLocation(LocationMap lm, ImageLocationInfo upto) {
            ...
            if (expansionLoc != null) {
                ...
                return new ASTImageLocation(IASTImageLocation.MACRO_DEFINITION, expansionLoc.getFileName(), expansionLoc.getNodeOffset() + fOffset, length);
            }
            return null;
        }
    ...
    public static class ParameterImageLocationInfo extends ImageLocationInfo {
        ...
        public IASTImageLocation createLocation(LocationMap lm, ImageLocationInfo upto) {
            ...
            if (loc != null) {
                return new ASTImageLocation(IASTImageLocation.ARGUMENT_TO_MACRO_EXPANSION, loc.getFileName(), loc.getNodeOffset(), loc.getNodeLength());
            }
            return null;
        }
