...
public class CPPASTImplicitName extends CPPASTName implements IASTImplicitName {
    ...
    public boolean accept(ASTVisitor action) {
        if ((!alternate && action.shouldVisitImplicitNames) || (alternate && action.shouldVisitImplicitNameAlternates)) {
    ...
    private boolean computeOperatorOffsetsFallback(IASTNode relativeNode, boolean trailing) {
        ...
        int start = trailing ? relative.getOffset() + relative.getLength() : sib != null ? sib.getOffset() + sib.getLength() : par.getOffset();
        @SuppressWarnings("null")
