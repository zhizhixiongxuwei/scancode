...
public class CPPDeferredFunction extends CPPUnknownBinding implements ICPPDeferredFunction, ICPPComputableFunction, ISerializableType {
    ...
    static final public ICPPFunctionType FUNCTION_TYPE = new CPPFunctionType(ProblemType.UNKNOWN_FOR_EXPRESSION, IType.EMPTY_TYPE_ARRAY, null);
    ...
    final public IBinding fOwner;

    final public ICPPFunction[] fCandidates;
