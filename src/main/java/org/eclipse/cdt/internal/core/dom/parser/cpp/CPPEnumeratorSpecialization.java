...
public class CPPEnumeratorSpecialization extends CPPSpecialization implements ICPPInternalEnumerator {
    ...
    final public IType fInternalType;

    public CPPEnumeratorSpecialization(IEnumerator specialized, ICPPEnumerationSpecialization owner, ICPPTemplateParameterMap argumentMap, IValue value, IType internalType) {
