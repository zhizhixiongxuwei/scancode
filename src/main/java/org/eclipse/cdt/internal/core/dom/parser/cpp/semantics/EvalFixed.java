...
public final class EvalFixed extends CPPEvaluation {
    ...
    public static final ICPPEvaluation INCOMPLETE = new EvalFixed(ProblemType.UNKNOWN_FOR_EXPRESSION, PRVALUE, IntegralValue.ERROR);

    final public IType fType;

    final public IValue fValue;

    final public ValueCategory fValueCategory;

    public boolean fIsTypeDependent;
    ...
    public String toString() {
        //$NON-NLS-1$
        return fType.toString() + ": " + fValue.toString();
    }
