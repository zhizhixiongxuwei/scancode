...
public class CPPASTLiteralExpression extends ASTNode implements ICPPASTLiteralExpression {
    ...
    static final public EvalFixed EVAL_NULL_PTR = new EvalFixed(CPPBasicType.NULL_PTR, PRVALUE, IntegralValue.create(0));
    ...
    // Accounting for escape sequences and the null terminator.
    ...
    public IASTImplicitDestructorName[] getImplicitDestructorNames() {
        // Literal expression does not call destructors.
    ...
    public char[] getOperatorName() {
        //$NON-NLS-1$
        return CharArrayUtils.concat("operator \"\"".toCharArray(), fSuffix);
    }
