...
public class CPPClassTemplatePartialSpecializationSpecialization extends CPPClassSpecialization implements ICPPClassTemplatePartialSpecializationSpecialization, ICPPInternalClassTemplate {
    ...
    public ObjectMap instances;

    public ICPPDeferredClassInstance fDeferredInstance;

    final public ICPPClassTemplate fClassTemplate;

    final public ICPPTemplateArgument[] fArguments;

    public CPPClassTemplatePartialSpecializationSpecialization(ICPPClassTemplatePartialSpecialization orig, ICPPTemplateParameterMap argumentMap, ICPPClassTemplate template, ICPPTemplateArgument[] args) throws DOMException {
