...
public class LanguageSettingsSerializableStorage extends LanguageSettingsStorage {
    ...
    //$NON-NLS-1$
    static final public String ELEM_LANGUAGE = "language";

    //$NON-NLS-1$
    static final public String ATTR_LANGUAGE_ID = "id";

    //$NON-NLS-1$
    static final public String ELEM_RESOURCE = "resource";

    //$NON-NLS-1$
    static final public String ATTR_PROJECT_PATH = "project-relative-path";

    static final public String ELEM_ENTRY = LanguageSettingsExtensionManager.ELEM_ENTRY;
