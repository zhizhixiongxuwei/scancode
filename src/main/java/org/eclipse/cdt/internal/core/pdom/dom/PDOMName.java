...
public final class PDOMName implements IIndexFragmentName {
    ...
    static final public int CALLER_REC_OFFSET = 8;
    ...
    // 3-byte unsigned int (sufficient for files <= 16mb)
    private static final int NODE_OFFSET_OFFSET = 24;

    // short (sufficient for names <= 32k)
    ...
    public PDOMName(PDOMLinkage linkage, IASTName name, PDOMFile file, PDOMBinding binding, PDOMName caller, boolean isPotentialMatch) throws CoreException {
