...
final public class CPPASTAmbiguityResolver extends ASTVisitor {
            ...
            while (node != null) {
                ...
                if (node instanceof IASTParameterDeclaration) {
                    ...
                    if (parent instanceof IASTDeclarator) {
                        ...
                        if (dtor == ASTQueries.findTypeRelevantDeclarator(dtor) && ASTQueries.findOutermostDeclarator(dtor).getParent() instanceof IASTDeclaration) {
    ...
    public int visit(IASTDeclaration decl) {
        if (decl instanceof IASTFunctionDefinition && !shouldProcessNow((IASTFunctionDefinition) decl)) {
            ...
            // Initializers may refer to class members declared later.
            fSkipInitializers++;
            fdecl.accept(this);
            fSkipInitializers--;
