...
public class CPPASTDesignatedInitializer extends ASTNode implements ICPPASTDesignatedInitializer, IASTAmbiguityParent {
    ...
    public ICPPASTInitializerClause rhs;

    public ICPPASTDesignator[] designators = ICPPASTDesignator.EMPTY_ARRAY;

    public int designatorsPos;
    ...
    public CPPASTDesignatedInitializer copy(CopyStyle style) {
        CPPASTDesignatedInitializer copy = new CPPASTDesignatedInitializer(rhs == null ? null : (ICPPASTInitializerClause) rhs.copy(style));
