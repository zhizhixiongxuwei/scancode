...
public class CPPASTTranslationUnit extends ASTTranslationUnit implements ICPPASTTranslationUnit, IASTAmbiguityParent {
    ...
    public CPPNamespaceScope fScope;

    public ICPPNamespace fBinding;

    final public CPPScopeMapper fScopeMapper;

    public CPPASTAmbiguityResolver fAmbiguityResolver;

    // Caches.
    final public Map<ICPPClassType, FinalOverriderMap> fFinalOverriderMapCache = new HashMap<>();
    ...
    private void addBuiltinOperators(CPPScope theScope) {
        ...
        temp = new CPPImplicitFunction(OverloadableOperator.DELETE.toCharArray(), theScope, deleteFunctionType, deleteTheParms, false, false);
        theScope.addBinding(temp);
        // void operator delete[](void*);
        temp = null;
        temp = new CPPImplicitFunction(OverloadableOperator.DELETE_ARRAY.toCharArray(), theScope, deleteFunctionType, deleteTheParms, false, false);
        theScope.addBinding(temp);
    }
    ...
    public void recordPartialSpecialization(ICPPClassTemplatePartialSpecialization indexSpec, ICPPClassTemplatePartialSpecialization astSpec) {
