...
public class PDOMCPPParameterSpecialization extends PDOMCPPSpecialization implements ICPPParameter {
    ...
    public PDOMCPPParameterSpecialization(PDOMCPPLinkage linkage, PDOMCPPFunctionSpecialization parent, ICPPParameter astParam, PDOMCPPParameter original, PDOMCPPParameterSpecialization next) throws CoreException {
        super(linkage, parent, (ICPPSpecialization) astParam, original);
        // This constructor is used for adding parameters to the database, only.
        fType = null;
