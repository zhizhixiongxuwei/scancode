...
public class CPPASTConditionalExpression extends ASTNode implements IASTConditionalExpression, ICPPASTExpression, IASTAmbiguityParent {
    ...
    public ICPPASTExpression fCondition;

    public ICPPASTExpression fPositive;

    public ICPPASTExpression fNegative;

    public ICPPEvaluation fEval;
    ...
    public ICPPEvaluation getEvaluation() {
        if (fEval == null) {
            if (fCondition == null || fNegative == null) {
                ...
                fEval = new EvalConditional(condEval, posEval, negEval, isThrowExpression(fPositive), isThrowExpression(fNegative), this);
            }
        }
        return fEval;
    }
