...
public class InternalFileContent extends FileContent {
    ...
    final public InclusionKind fKind;

    final public AbstractCharArray fSource;

    final public List<IIndexMacro> fMacroDefinitions;

    final public List<ICPPUsingDirective> fUsingDirectives;

    final public String fFileLocation;
     ...
     * this constructor.
     */
    public InternalFileContent(String fileLocation, InclusionKind kind, ISignificantMacros significantMacros) throws IllegalArgumentException {
