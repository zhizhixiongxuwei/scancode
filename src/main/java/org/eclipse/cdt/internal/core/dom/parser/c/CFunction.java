...
public class CFunction extends PlatformObject implements IFunction, ICInternalFunction {
    ...
    public IASTDeclarator[] declarators;

    public IASTFunctionDeclarator definition;

    static final public int FULLY_RESOLVED = 1;

    static final public int RESOLUTION_IN_PROGRESS = 1 << 1;
    ...
    public IBinding resolveParameter(IASTName paramName) {
        ...
        while (parent instanceof IASTDeclarator && !(parent instanceof ICASTKnRFunctionDeclarator)) parent = parent.getParent();
