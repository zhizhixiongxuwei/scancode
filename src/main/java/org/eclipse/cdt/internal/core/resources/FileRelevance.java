...
public class FileRelevance {
    ...
    static final public int PREFERRED_PROJECT = 0x40;

    static final public int CDT_PROJECT = 0x20;

    static final public int ON_SOURCE_ROOT = 0x10;

    // Penalty for undesirable attributes
    static final public int LINK_PENALTY = 1;

    static final public int INACCESSIBLE_SHIFT = 4;
