...
public class CStructure extends PlatformObject implements ICompositeType, ICInternalBinding {
    ...
    public ICompositeType typeInIndex;
    ...
    public IField[] getFields() {
        checkForDefinition();
        if (definition == null) {
            return new IField[] { new CField.CFieldProblem(this, declarations[0], IProblemBinding.SEMANTIC_DEFINITION_NOT_FOUND, getNameCharArray()) };
        }
    ...
    public IField findField(String name) {
        ...
        if (scope == null) {
            return new CField.CFieldProblem(this, declarations[0], IProblemBinding.SEMANTIC_DEFINITION_NOT_FOUND, getNameCharArray());
        }
    ...
    @Override
    public int getKey() {
        return definition != null ? ((IASTCompositeTypeSpecifier) definition.getParent()).getKey() : ((IASTElaboratedTypeSpecifier) declarations[0].getParent()).getKind();
    }
    ...
    public IBinding getOwner() {
        ...
        // local or global
        IBinding result = CVisitor.findEnclosingFunction(node);
        if (result != null)
            return result;
