...
public class ExecFor implements ICPPExecution {
    ...
    final public ICPPExecution initializerExec;

    final public ICPPEvaluation conditionExprEval;

    final public ExecSimpleDeclaration conditionDeclExec;

    final public ICPPEvaluation iterationEval;
    ...
    public ICPPExecution instantiate(InstantiationContext context, int maxDepth) {
        ...
        if (newInitializerExec == initializerExec && newConditionExprEval == conditionExprEval && newConditionDeclExec == conditionDeclExec && newIterationEval == iterationEval && newBodyExec == bodyExec) {
            return this;
        }
