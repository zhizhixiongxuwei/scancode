...
public class SingleMacroExpansionExplorer extends MacroExpansionExplorer {
    ...
    final public String fInput;

    final public CharArrayMap<PreprocessorMacro> fDictionary;

    public MacroExpansionStep fFullExpansion;

    public int fExpansionCount;
    ...
    public SingleMacroExpansionExplorer(String input, IASTName[] refs, Map<IMacroBinding, IASTFileLocation> macroDefinitionLocationMap, String filePath, int lineNumber, boolean isPPCondition, LexerOptions options) {
        fInput = input;
