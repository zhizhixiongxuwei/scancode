...
public class PDOMCPPAliasTemplateSpecialization extends PDOMCPPSpecialization implements ICPPAliasTemplate {
    ...
    // TYPE_SIZE
    static final public int ALIASED_TYPE = PDOMCPPSpecialization.RECORD_SIZE;

    // PTR_SIZE
    static final public int TEMPLATE_PARAMS = ALIASED_TYPE + Database.TYPE_SIZE;

    @SuppressWarnings("hiding")
    static final public int RECORD_SIZE = TEMPLATE_PARAMS + Database.PTR_SIZE;

    volatile public IPDOMCPPTemplateParameter[] fParameters;

    public PDOMCPPAliasTemplateSpecialization(PDOMCPPLinkage linkage, PDOMNode parent, ICPPAliasTemplate aliasTemplateSpec, IPDOMBinding specialized) throws CoreException, DOMException {
