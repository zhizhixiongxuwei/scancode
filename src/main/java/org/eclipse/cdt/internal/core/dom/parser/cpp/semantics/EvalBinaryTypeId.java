...
public class EvalBinaryTypeId extends CPPDependentEvaluation {
    ...
    final public Operator fOperator;

    final public IType fType1, fType2;

    public boolean fCheckedValueDependent;

    public boolean fIsValueDependent;
    ...
    public int determinePackSize(ICPPTemplateParameterMap tpMap) {
        return CPPTemplates.combinePackSize(CPPTemplates.determinePackSize(fType1, tpMap), CPPTemplates.determinePackSize(fType2, tpMap));
    }
