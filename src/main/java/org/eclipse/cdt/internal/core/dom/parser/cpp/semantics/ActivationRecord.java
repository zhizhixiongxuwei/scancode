...
public class ActivationRecord {
    ...
    final public Map<IBinding, ICPPEvaluation> vars = new HashMap<>();

    final public ICPPParameter[] params;

    final public ICPPEvaluation[] args;

    final public ICPPEvaluation implicitThis;
