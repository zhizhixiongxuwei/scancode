...
public class CPPNodeFactory extends NodeFactory implements ICPPNodeFactory {
    ...
    static final public CPPNodeFactory DEFAULT_INSTANCE = new CPPNodeFactory();
    ...
    @Override
    public ICPPASTForStatement newForStatement(IASTStatement init, IASTDeclaration condition, IASTExpression iterationExpression, IASTStatement body) {
        return new CPPASTForStatement(init, condition, iterationExpression, body);
    }

    @Override
    public ICPPASTForStatement newForStatement(IASTStatement init, IASTExpression condition, IASTExpression iterationExpr, IASTStatement body) {
    ...
    @Override
    public ICPPASTFunctionDefinition newFunctionDefinition(IASTDeclSpecifier declSpecifier, IASTFunctionDeclarator declarator, IASTStatement bodyStatement) {
        return new CPPASTFunctionDefinition(declSpecifier, declarator, bodyStatement);
    }

    @Override
    public ICPPASTFunctionWithTryBlock newFunctionTryBlock(IASTDeclSpecifier declSpecifier, IASTFunctionDeclarator declarator, IASTStatement bodyStatement) {
    ...
    @Override
    public ICPPASTFoldExpression newFoldExpression(int operator, boolean fIsComma, IASTExpression lhs, IASTExpression rhs) {
    ...
    @Override
    public ICPPASTStructuredBindingDeclaration newStructuredBindingDeclaration(ICPPASTSimpleDeclSpecifier declSpecifier, RefQualifier refQualifier, IASTName[] names, IASTInitializer initializer) {
