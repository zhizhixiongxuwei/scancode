...
public class AsmModelBuilder implements IContributedModelBuilder {
    ...
    static final public Map<String, AsmDirective> fgDirectives;
    ...
    public TranslationUnit fTranslationUnit;

    public char fLineSeparatorChar;

    public Map<String, Counter> fGlobals;

    public Map<String, Counter> fLabels;
