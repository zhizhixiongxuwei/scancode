...
public class SignificantMacros implements ISignificantMacros {
    ...
    static final public Comparator<char[]> SORTER = new Comparator<>() {
    ...
    public boolean equals(Object obj) {
        return obj instanceof SignificantMacros && hashCode() == obj.hashCode() && CharArrayUtils.equals(fEncoded, ((SignificantMacros) obj).fEncoded);
    }
