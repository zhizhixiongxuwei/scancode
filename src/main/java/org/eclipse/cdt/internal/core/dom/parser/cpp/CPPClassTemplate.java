...
public class CPPClassTemplate extends CPPTemplateDefinition implements ICPPClassTemplate, ICPPInternalClassTemplate, ICPPInternalClassTypeMixinHost {
    ...
    public ICPPClassTemplatePartialSpecialization[] partialSpecializations;

    public ICPPDeferredClassInstance fDeferredInstance;

    public boolean addedPartialSpecializationsOfIndex;
    ...
    public void addPartialSpecialization(ICPPClassTemplatePartialSpecialization spec) {
        partialSpecializations = ArrayUtil.append(ICPPClassTemplatePartialSpecialization.class, partialSpecializations, spec);
    }
    ...
    public ICPPClassScope getCompositeScope() {
        ...
        if (definition != null) {
            ...
            while (parent instanceof IASTName) parent = parent.getParent();
