...
public final class CPPVariableReadWriteFlags extends VariableReadWriteFlags {
    ...
    static public CPPVariableReadWriteFlags INSTANCE = new CPPVariableReadWriteFlags();
    ...
    protected Optional<Integer> rwAnyNode(IASTNode node, int indirection) {
        ...
        if (parent instanceof ICPPASTFieldDesignator) {
            // Field is initialized via a designated initializer.
                ...
                if (candidates != null) {
                    ...
                    for (ICPPFunction f : candidates) {
                        ...
                        if (type instanceof IFunctionType) {
                            Optional<Integer> res = rwArgumentForFunctionCall((IFunctionType) type, argPos, args[argPos], indirection);
