...
public final class StreamHasher {
    ...
    // PI
    static final public long SEED = 3141592653589793238L;

    static final public long EMPTY_STRING_HASH = new StreamHasher().computeHashInternal();

    // Current position in the stream of characters.
    public long hashedOffset;

    // Current position in the stream of characters modulo 6, or -1 after computeHash is called.
    public int state;
    ...
    private long computeHashInternal() {
        ...
        // Protect against subsequent calls.
        state = -1;
        finalMix();
