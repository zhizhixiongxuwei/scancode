 ...
 */
public class CPPTemplateTemplateParameterSpecialization extends CPPTemplateParameterSpecialization implements ICPPTemplateTemplateParameter {
    ...
    public ICPPScope fScope;

    public CPPTemplateTemplateParameterSpecialization(ICPPSpecialization owner, ICPPScope scope, ICPPTemplateTemplateParameter specialized, ICPPTemplateArgument defaultValue) {
