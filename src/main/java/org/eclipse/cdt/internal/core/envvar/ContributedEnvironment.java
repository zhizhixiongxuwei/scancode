...
public class ContributedEnvironment implements IContributedEnvironment {
    ...
    public EnvironmentVariableManager fMngr;
    ...
    public IEnvironmentVariable[] getVariables(ICConfigurationDescription des) {
        ...
        if (cr != null) {
            ...
            //getContextInfo(des);
            IEnvironmentContextInfo info = new DefaultEnvironmentContextInfo(des);
    ...
    public void addVariables(IEnvironmentVariable[] vars, ICConfigurationDescription des) {
        for (IEnvironmentVariable v : vars) addVariable(v, des);
    }
