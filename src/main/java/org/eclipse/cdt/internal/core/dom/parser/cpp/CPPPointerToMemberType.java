...
public class CPPPointerToMemberType extends CPPPointerType implements ICPPPointerToMemberType {
    ...
    public ICPPASTPointerToMember operator;

    // Can be either ICPPClassType or ICPPTemplateTypeParameter
    ...
    public static IType unmarshal(short firstBytes, ITypeMarshalBuffer buffer) throws CoreException {
        ...
        return new CPPPointerToMemberType(nested, memberOf, (firstBytes & ITypeMarshalBuffer.FLAG1) != 0, (firstBytes & ITypeMarshalBuffer.FLAG2) != 0, (firstBytes & ITypeMarshalBuffer.FLAG3) != 0);
    }
}
