...
public class CPPASTLambdaExpression extends ASTNode implements ICPPASTLambdaExpression {
    ...
    static final public ICPPASTCapture[] NO_CAPTURES = {};

    public CaptureDefault fCaptureDefault;

    public ICPPASTCapture[] fCaptures;

    public ICPPASTFunctionDeclarator fDeclarator;

    public IASTCompoundStatement fBody;
    ...
    public IASTImplicitDestructorName[] getImplicitDestructorNames() {
        // Lambda expression is never a full-expression.
