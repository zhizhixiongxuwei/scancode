...
public class ExpressionEvaluator {
    ...
    public Token fTokens;

    public CharArrayMap<PreprocessorMacro> fDictionary;

    public ArrayList<IASTName> fMacrosInDefinedExpressions = new ArrayList<>();

    public LocationMap fLocationMap;

    public CPreprocessor fPreprocessor;
    ...
    private long relationalExpression() throws EvalException {
        ...
        for (int t = LA(); t == IToken.tLT || t == IToken.tLTEQUAL || t == IToken.tGT || t == IToken.tGTEQUAL || t == IToken.tASSIGN; t = LA()) {
            consume();
