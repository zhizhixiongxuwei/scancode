...
public abstract class CPPASTNameBase extends ASTNode implements ICPPASTName {
    ...
    //$NON-NLS-1$
    static final public Pattern WHITESPACE_SEQ = Pattern.compile("\\s+");
    ...
    static final public byte MAX_RESOLUTION_DEPTH = 6;
    ...
    private RecursionResolvingBinding createRecursionResolvingBinding() {
        ...
        //$NON-NLS-1$
        char[] args = (fResolutionDepth > MAX_RESOLUTION_DEPTH + 1) ? "(unknown)".toCharArray() : null;
        return new RecursionResolvingBinding(this, args);
    }

    public IBinding fBinding;
