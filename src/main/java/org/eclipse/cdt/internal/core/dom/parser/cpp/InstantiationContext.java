...
public final class InstantiationContext {
    ...
    public CPPTemplateParameterMap parameterMap;

    public boolean forDeduction = false;

    public int packOffset;

    final public ICPPSpecialization contextSpecialization;

    public boolean expandPack;
