...
public class TokenUtil {
    ...
    //$NON-NLS-1$
    static final public char[] IMAGE_POUND_POUND = "##".toCharArray();

    //$NON-NLS-1$
    static final public char[] IMAGE_POUND = "#".toCharArray();

    //$NON-NLS-1$
    static final public char[] DIGRAPH_LBRACE = "<%".toCharArray();

    //$NON-NLS-1$
    static final public char[] DIGRAPH_RBRACE = "%>".toCharArray();
