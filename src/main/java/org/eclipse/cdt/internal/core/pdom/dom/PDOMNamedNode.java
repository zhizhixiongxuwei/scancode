...
public abstract class PDOMNamedNode extends PDOMNode {
     ...
     */
    static final public int NAME = PDOMNode.RECORD_SIZE + 0;

    /**
     * The size in bytes of a PDOMNamedNode record in the database.
     */
    @SuppressWarnings("hiding")
    static final public int RECORD_SIZE = PDOMNode.RECORD_SIZE + Database.PTR_SIZE;

    volatile public char[] fName;
