...
public class CLanguageSettingCache extends CDefaultLanguageData implements ICLanguageSetting, ICachedData {
    ...
    public ICResourceDescription fParent;

    public EntryStore fResolvedEntriesStore;

    public String[] fCachedExtensions;

    public boolean fContainsDiscoveredScannerInfo = true;
