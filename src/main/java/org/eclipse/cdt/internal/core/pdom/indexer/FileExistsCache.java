...
public final class FileExistsCache {
    ...
    static final public Content EMPTY_STRING_ARRAY = new Content(new String[0]);

    //$NON-NLS-1$
    static public boolean BYPASS_CACHE = Boolean.getBoolean("CDT_INDEXER_BYPASS_FILE_EXISTS_CACHE");
    ...
    public Reference<Map<String, Content>> fCache;

    // Cache for recent results of isFile calls (bug 471103).
    final public Map<String, Boolean> fCacheIsFile = new HashMap<>();

    final public boolean fCaseInSensitive;
