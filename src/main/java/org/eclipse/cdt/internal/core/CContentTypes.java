...
public class CContentTypes {
    ...
    //$NON-NLS-1$
    static final public String PREF_LOCAL_CONTENT_TYPE_SETTINGS = "enabled";

    static final public Preferences PROJECT_SCOPE = Platform.getPreferencesService().getRootNode().node(ProjectScope.SCOPE);

    //$NON-NLS-1$
    static final public String CONTENT_TYPE_PREF_NODE = "content-types";

    static final public String FULLPATH_CONTENT_TYPE_PREF_NODE = Platform.PI_RUNTIME + IPath.SEPARATOR + CONTENT_TYPE_PREF_NODE;
