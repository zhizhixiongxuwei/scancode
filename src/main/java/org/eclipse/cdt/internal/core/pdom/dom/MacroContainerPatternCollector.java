...
public final class MacroContainerPatternCollector implements IBTreeVisitor {
    ...
    final public List<PDOMMacroContainer> macros = new ArrayList<>();

    final public Pattern fPattern;

    final public IProgressMonitor fMonitor;

    public int fMonitorCheckCounter = 0;
