...
public class CPPUsingDeclarationSpecialization extends CPPSpecialization implements ICPPUsingDeclaration {
    ...
    final public IBinding[] fDelegates;

    public CPPUsingDeclarationSpecialization(ICPPUsingDeclaration specialized, IBinding owner, ICPPTemplateParameterMap tpmap, IBinding[] delegates) {
