...
public class ExecIf implements ICPPExecution {
    ...
    public ICPPExecution instantiate(InstantiationContext context, int maxDepth) {
        ...
        if (newInitStmtExec == initStmtExec && newConditionExprEval == conditionExprEval && newConditionDeclExec == conditionDeclExec && newThenClauseExec == thenClauseExec && newElseClauseExec == elseClauseExec) {
            return this;
        }
