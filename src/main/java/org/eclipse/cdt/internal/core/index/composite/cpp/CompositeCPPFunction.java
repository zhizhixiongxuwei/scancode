...
public class CompositeCPPFunction extends CompositeCPPBinding implements ICPPFunction, ICPPComputableFunction {
    ...
    public String toString() {
        //$NON-NLS-1$
        return getName() + " " + ASTTypeUtil.getParameterTypeString(getType());
    }
