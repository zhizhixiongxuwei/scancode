...
public class CConfigurationDescription extends CDataProxyContainer implements ICConfigurationDescription, IProxyFactory, IInternalCCfgInfo, ILanguageSettingsProvidersKeeper {
    ...
    public CfgProxyCache fCache;

    //	private ProxyProvider fFileProxyProvider;
    //	private ProxyProvider fFolderProxyProvider;
    //	private ProxyProvider fRcProxyProvider;
    public PathSettingsContainer fPathContainer;

    public ResourceDescriptionHolder fRcHolder;

    public CConfigurationSpecSettings fCfgSpecSettings;
    ...
    public ICFileDescription createFileDescription(IPath path, ICResourceDescription base) throws CoreException, WriteAccessException {
        ...
        if (!(proxy instanceof ICFileDescription))
            ...
            SettingsModelMessages.getString("CConfigurationDescription.1") + proxy.getClass().getName());
    ...
    public ICFolderDescription createFolderDescription(IPath path, ICFolderDescription base) throws CoreException, WriteAccessException {
        ...
        if (!(proxy instanceof ICFolderDescription))
            throw ExceptionFactory.createCoreException(//$NON-NLS-1$
            SettingsModelMessages.getString("CConfigurationDescription.3") + proxy.getClass().getName());
