...
public class PDOMCPPVariableInstance extends PDOMCPPSpecialization implements ICPPVariableInstance {
    ...
    static final public int TEMPLATE_ARGUMENTS = PDOMCPPSpecialization.RECORD_SIZE + 0;

    static final public int TYPE = TEMPLATE_ARGUMENTS + Database.PTR_SIZE;

    static final public int VALUE = TYPE + Database.TYPE_SIZE;

    // byte
    static final public int ANNOTATIONS = VALUE + Database.VALUE_SIZE;
    ...
    public PDOMCPPVariableInstance(PDOMCPPLinkage linkage, PDOMNode parent, ICPPVariableInstance specialization, IPDOMBinding orig) throws CoreException {
    ...
    public boolean isAuto() {
        ...
        return !PDOMCPPAnnotations.isExtern(annotation) && !PDOMCPPAnnotations.isStatic(annotation) && getOwner() instanceof ICPPFunction;
    }
    ...
    public boolean isRegister() {
        // We don't care whether the parameter has register storage class specifier or not.
        return false;
    }
