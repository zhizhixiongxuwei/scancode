...
public class CPPEnumerationSpecialization extends CPPSpecialization implements ICPPEnumerationSpecialization {
    ...
    final public IEnumerator[] fEnumerators;

    final public IType fFixedType;

    public boolean fInitializationComplete;

    public static IBinding createInstance(ICPPEnumeration enumeration, ICPPClassSpecialization owner, ICPPTemplateParameterMap tpMap) {
    ...
    private void initialize() {
        ...
        for (int i = 0; i < enumerators.length; ++i) {
            ...
            IValue specializedValue = CPPTemplates.instantiateValue(enumerator.getValue(), context, IntegralValue.MAX_RECURSION_DEPTH);
    ...
    public boolean isSameType(IType type) {
        ...
        return getSpecializedBinding().isSameType(otherEnumSpec.getSpecializedBinding()) && ((IType) getOwner()).isSameType((IType) otherEnumSpec.getOwner());
    }
