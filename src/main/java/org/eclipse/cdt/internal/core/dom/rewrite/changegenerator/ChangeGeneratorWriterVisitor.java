...
public class ChangeGeneratorWriterVisitor extends ASTWriterVisitor {
    ...
    final public ASTModificationStore modificationStore;

    final public String fileScope;

    public ModificationScopeStack stack;

    public ChangeGeneratorWriterVisitor(ASTVisitor delegateVisitor, ASTModificationStore modificationStore, String fileScope, NodeCommentMap commentMap, boolean placeConstRight) {
        super(commentMap);
    ...
    public ChangeGeneratorWriterVisitor(ASTModificationStore modStore, String fileScope, NodeCommentMap commentMap, boolean placeConstRight) {
        super(commentMap);
