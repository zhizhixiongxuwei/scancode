 ...
 */
public class CPPASTTemplateDeclaration extends ASTNode implements ICPPASTInternalTemplateDeclaration, IASTAmbiguityParent {

    public boolean exported;

    public byte isAssociatedWithLastName = -1;

    public short nestingLevel = -1;

    public IASTDeclaration declaration;

    public ICPPTemplateScope templateScope;
    ...
    public CPPASTTemplateDeclaration copy(CopyStyle style) {
        ...
        for (ICPPASTTemplateParameter param : getTemplateParameters()) copy.addTemplateParameter(param == null ? null : param.copy(style));
