 ...
 */
public class CPPASTDeclarator extends CPPASTConstraintOwner implements ICPPASTDeclarator, IASTImplicitNameOwner, ICPPExecutionOwner {
    ...
    public ICPPExecution getExecution() {
        ...
        if (// ProblemBinding
        !(binding instanceof ICPPBinding))
