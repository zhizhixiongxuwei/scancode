 ...
 */
public class CPPFieldTemplateSpecialization extends CPPFieldSpecialization implements ICPPFieldTemplate, ICPPInternalTemplate {

    public ICPPTemplateParameter[] templateParameters;

    public ObjectMap instances;

    public CPPFieldTemplateSpecialization(IBinding orig, ICPPClassType owner, ICPPTemplateParameterMap tpmap, IType type, IValue value) {
