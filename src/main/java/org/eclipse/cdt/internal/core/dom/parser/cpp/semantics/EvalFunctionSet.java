...
public class EvalFunctionSet extends CPPDependentEvaluation {
    ...
    // Otherwise null.
    final public IType fImpliedObjectType;
    ...
    public ICPPEvaluation instantiate(InstantiationContext context, int maxDepth) {
        ...
        if (Arrays.equals(arguments, originalArguments) && functions == originalFunctions)
            return this;
        return new EvalFunctionSet(new CPPFunctionSet(functions, arguments, null), fQualified, fAddressOf, fImpliedObjectType, getTemplateDefinition());
    }
