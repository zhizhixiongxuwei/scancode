...
public class PDOMCPPUsingDirective implements ICPPUsingDirective, IPDOMNode {
    ...
    static final public int CONTAINER_NAMESPACE = 0;

    static final public int NOMINATED_NAMESPACE = 4;

    static final public int PREV_DIRECTIVE_OF_FILE = 8;

    static final public int FILE_OFFSET = 12;

    static final public int RECORD_SIZE = 16;
