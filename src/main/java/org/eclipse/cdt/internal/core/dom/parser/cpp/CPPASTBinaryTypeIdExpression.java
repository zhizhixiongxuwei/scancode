...
public class CPPASTBinaryTypeIdExpression extends ASTNode implements ICPPASTExpression, IASTBinaryTypeIdExpression {
    ...
    public Operator fOperator;

    public IASTTypeId fOperand1;

    public IASTTypeId fOperand2;
    ...
    public CPPASTBinaryTypeIdExpression copy(CopyStyle style) {
        CPPASTBinaryTypeIdExpression copy = new CPPASTBinaryTypeIdExpression(fOperator, fOperand1 == null ? null : fOperand1.copy(style), fOperand2 == null ? null : fOperand2.copy(style));
    ...
    public IASTImplicitDestructorName[] getImplicitDestructorNames() {
        // Binary type-id expressions don't call destructors.
