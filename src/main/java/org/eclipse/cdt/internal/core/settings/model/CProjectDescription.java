...
public class CProjectDescription implements ICProjectDescription, ICDataProxyContainer {
    ...
    //$NON-NLS-1$
    static final public String ACTIVE_CFG = "activeConfiguration";

    static final public QualifiedName ACTIVE_CFG_PROPERTY = new QualifiedName(CCorePlugin.PLUGIN_ID, ACTIVE_CFG);

    //$NON-NLS-1$
    static final public String SETTING_CFG = "settingConfiguration";

    static final public QualifiedName SETTING_CFG_PROPERTY = new QualifiedName(CCorePlugin.PLUGIN_ID, SETTING_CFG);

    public CfgIdPair fActiveCfgInfo;
    ...
    public CProjectDescription(IProject project, ICSettingsStorage storage, ICStorageElement element, boolean loading, boolean isCreating) throws CoreException {
        ...
        fPrefs = new CProjectDescriptionPreferences(el, (CProjectDescriptionPreferences) mngr.getProjectDescriptionWorkspacePreferences(false), false);
    ...
    ICSettingsStorage getStorageBase() throws CoreException {
        if (fStorage == null)
            ...
            throw //$NON-NLS-1$
            ExceptionFactory.createCoreException("CProjectDescription ICSettingsStorage == null");
        return fStorage;
    }
