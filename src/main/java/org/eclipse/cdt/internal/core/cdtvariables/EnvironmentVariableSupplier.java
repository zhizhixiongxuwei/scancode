...
public class EnvironmentVariableSupplier extends CoreMacroSupplierBase {
    ...
    static public EnvironmentVariableSupplier fInstance;

    public EnvironmentVariableManager fEnvironmentProvider;
    ...
    public ICdtVariable[] getMacros(int contextType, Object contextData) {
        ...
        if (vars != null) {
            ...
            for (int i = 0; i < macros.length; i++) macros[i] = new EnvVarMacro(vars[i]);
            return macros;
        }
        return null;
    }
