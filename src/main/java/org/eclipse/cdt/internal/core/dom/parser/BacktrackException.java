...
public class BacktrackException extends Exception {
    ...
    static final public StackTraceElement[] EMPTY_STACK = new StackTraceElement[0];

    public IASTProblem problem;

    // a node has been created in spite of the problem.
    public IASTNode nodeBeforeProblem;
