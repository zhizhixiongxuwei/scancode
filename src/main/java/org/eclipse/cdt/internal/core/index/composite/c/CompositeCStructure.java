...
public class CompositeCStructure extends CompositeCBinding implements ICompositeType, IIndexType {
    ...
    public IField[] getFields() {
        ...
        for (int i = 0; i < result.length; i++) result[i] = (IField) cf.getCompositeBinding((IIndexFragmentBinding) result[i]);
        return result;
    }
