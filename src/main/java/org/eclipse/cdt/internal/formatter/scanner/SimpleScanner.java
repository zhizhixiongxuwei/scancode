...
public class SimpleScanner {
    ...
    static final public int EOFCHAR = -1;

    static public HashMap<String, Integer> fgKeywords = new HashMap<>();

    public Token fCurrentToken;

    public ScannerContext fContext;

    public StringBuilder fTokenBuffer = new StringBuilder();
    ...
    public Token nextToken() {
        ...
        while (c != EOFCHAR) {
            ...
            if ((c == ' ') || (c == '\r') || (c == '\t') || (c == '\n')) {
                ...
                madeMistake = false;
                c = getChar();
                while (((c >= 'a') && (c <= 'z')) || ((c >= 'A') && (c <= 'Z')) || ((c >= '0') && (c <= '9')) || (c == '_') || (c > 255 && Character.isUnicodeIdentifierPart(c))) {
                    c = getChar();
                }
                ungetChar(c);
    ...
    static {
        //$NON-NLS-1$
        fgKeywords.put("and", Integer.valueOf(Token.t_and));
        //$NON-NLS-1$
        fgKeywords.put("and_eq", Integer.valueOf(Token.t_and_eq));
        //$NON-NLS-1$
        fgKeywords.put("asm", Integer.valueOf(Token.t_asm));
        //$NON-NLS-1$
        fgKeywords.put("auto", Integer.valueOf(Token.t_auto));
        //$NON-NLS-1$
        fgKeywords.put("bitand", Integer.valueOf(Token.t_bitand));
        //$NON-NLS-1$
        fgKeywords.put("bitor", Integer.valueOf(Token.t_bitor));
        //$NON-NLS-1$
        fgKeywords.put("bool", Integer.valueOf(Token.t_bool));
        //$NON-NLS-1$
        fgKeywords.put("break", Integer.valueOf(Token.t_break));
        //$NON-NLS-1$
        fgKeywords.put("case", Integer.valueOf(Token.t_case));
        //$NON-NLS-1$
        fgKeywords.put("catch", Integer.valueOf(Token.t_catch));
        //$NON-NLS-1$
        fgKeywords.put("char", Integer.valueOf(Token.t_char));
        //$NON-NLS-1$
        fgKeywords.put("class", Integer.valueOf(Token.t_class));
        //$NON-NLS-1$
        fgKeywords.put("compl", Integer.valueOf(Token.t_compl));
        //$NON-NLS-1$
        fgKeywords.put("const", Integer.valueOf(Token.t_const));
        //$NON-NLS-1$
        fgKeywords.put("const_cast", Integer.valueOf(Token.t_const_cast));
        //$NON-NLS-1$
        fgKeywords.put("constexpr", Integer.valueOf(Token.t_constexpr));
        //$NON-NLS-1$
        fgKeywords.put("continue", Integer.valueOf(Token.t_continue));
        //$NON-NLS-1$
        fgKeywords.put("default", Integer.valueOf(Token.t_default));
        //$NON-NLS-1$
        fgKeywords.put("delete", Integer.valueOf(Token.t_delete));
        //$NON-NLS-1$
        fgKeywords.put("do", Integer.valueOf(Token.t_do));
        //$NON-NLS-1$
        fgKeywords.put("double", Integer.valueOf(Token.t_double));
        //$NON-NLS-1$
        fgKeywords.put("dynamic_cast", Integer.valueOf(Token.t_dynamic_cast));
        //$NON-NLS-1$
        fgKeywords.put("else", Integer.valueOf(Token.t_else));
        //$NON-NLS-1$
        fgKeywords.put("enum", Integer.valueOf(Token.t_enum));
        //$NON-NLS-1$
        fgKeywords.put("explicit", Integer.valueOf(Token.t_explicit));
        //$NON-NLS-1$
        fgKeywords.put("export", Integer.valueOf(Token.t_export));
        //$NON-NLS-1$
        fgKeywords.put("extern", Integer.valueOf(Token.t_extern));
        //$NON-NLS-1$
        fgKeywords.put("false", Integer.valueOf(Token.t_false));
        //$NON-NLS-1$
        fgKeywords.put("float", Integer.valueOf(Token.t_float));
        //$NON-NLS-1$
        fgKeywords.put("for", Integer.valueOf(Token.t_for));
        //$NON-NLS-1$
        fgKeywords.put("friend", Integer.valueOf(Token.t_friend));
        //$NON-NLS-1$
        fgKeywords.put("goto", Integer.valueOf(Token.t_goto));
        //$NON-NLS-1$
        fgKeywords.put("if", Integer.valueOf(Token.t_if));
        //$NON-NLS-1$
        fgKeywords.put("inline", Integer.valueOf(Token.t_inline));
        //$NON-NLS-1$
        fgKeywords.put("int", Integer.valueOf(Token.t_int));
        //$NON-NLS-1$
        fgKeywords.put("long", Integer.valueOf(Token.t_long));
        //$NON-NLS-1$
        fgKeywords.put("mutable", Integer.valueOf(Token.t_mutable));
        //$NON-NLS-1$
        fgKeywords.put("namespace", Integer.valueOf(Token.t_namespace));
        //$NON-NLS-1$
        fgKeywords.put("new", Integer.valueOf(Token.t_new));
        //$NON-NLS-1$
        fgKeywords.put("not", Integer.valueOf(Token.t_not));
        //$NON-NLS-1$
        fgKeywords.put("not_eq", Integer.valueOf(Token.t_not_eq));
        //$NON-NLS-1$
        fgKeywords.put("operator", Integer.valueOf(Token.t_operator));
        //$NON-NLS-1$
        fgKeywords.put("or", Integer.valueOf(Token.t_or));
        //$NON-NLS-1$
        fgKeywords.put("or_eq", Integer.valueOf(Token.t_or_eq));
        //$NON-NLS-1$
        fgKeywords.put("private", Integer.valueOf(Token.t_private));
        //$NON-NLS-1$
        fgKeywords.put("protected", Integer.valueOf(Token.t_protected));
        //$NON-NLS-1$
        fgKeywords.put("public", Integer.valueOf(Token.t_public));
        //$NON-NLS-1$
        fgKeywords.put("register", Integer.valueOf(Token.t_register));
        //$NON-NLS-1$
        fgKeywords.put("reinterpret_cast", Integer.valueOf(Token.t_reinterpret_cast));
        //$NON-NLS-1$
        fgKeywords.put("return", Integer.valueOf(Token.t_return));
        //$NON-NLS-1$
        fgKeywords.put("short", Integer.valueOf(Token.t_short));
        //$NON-NLS-1$
        fgKeywords.put("signed", Integer.valueOf(Token.t_signed));
        //$NON-NLS-1$
        fgKeywords.put("sizeof", Integer.valueOf(Token.t_sizeof));
        //$NON-NLS-1$
        fgKeywords.put("static", Integer.valueOf(Token.t_static));
        //$NON-NLS-1$
        fgKeywords.put("static_cast", Integer.valueOf(Token.t_static_cast));
        //$NON-NLS-1$
        fgKeywords.put("struct", Integer.valueOf(Token.t_struct));
        //$NON-NLS-1$
        fgKeywords.put("switch", Integer.valueOf(Token.t_switch));
        //$NON-NLS-1$
        fgKeywords.put("template", Integer.valueOf(Token.t_template));
        //$NON-NLS-1$
        fgKeywords.put("this", Integer.valueOf(Token.t_this));
        //$NON-NLS-1$
        fgKeywords.put("throw", Integer.valueOf(Token.t_throw));
        //$NON-NLS-1$
        fgKeywords.put("true", Integer.valueOf(Token.t_true));
        //$NON-NLS-1$
        fgKeywords.put("try", Integer.valueOf(Token.t_try));
        //$NON-NLS-1$
        fgKeywords.put("typedef", Integer.valueOf(Token.t_typedef));
        //$NON-NLS-1$
        fgKeywords.put("typeid", Integer.valueOf(Token.t_typeid));
        //$NON-NLS-1$
        fgKeywords.put("typename", Integer.valueOf(Token.t_typename));
        //$NON-NLS-1$
        fgKeywords.put("union", Integer.valueOf(Token.t_union));
        //$NON-NLS-1$
        fgKeywords.put("unsigned", Integer.valueOf(Token.t_unsigned));
        //$NON-NLS-1$
        fgKeywords.put("using", Integer.valueOf(Token.t_using));
        //$NON-NLS-1$
        fgKeywords.put("virtual", Integer.valueOf(Token.t_virtual));
        //$NON-NLS-1$
        fgKeywords.put("void", Integer.valueOf(Token.t_void));
        //$NON-NLS-1$
        fgKeywords.put("volatile", Integer.valueOf(Token.t_volatile));
        //$NON-NLS-1$
        fgKeywords.put("wchar_t", Integer.valueOf(Token.t_wchar_t));
        //$NON-NLS-1$
        fgKeywords.put("while", Integer.valueOf(Token.t_while));
        //$NON-NLS-1$
        fgKeywords.put("xor", Integer.valueOf(Token.t_xor));
        //$NON-NLS-1$
        fgKeywords.put("xor_eq", Integer.valueOf(Token.t_xor_eq));
        //$NON-NLS-1$
        fgKeywords.put("noexcept", Integer.valueOf(Token.t_noexcept));
        // additional java keywords
        //$NON-NLS-1$
        fgKeywords.put("abstract", Integer.valueOf(Token.t_abstract));
        //$NON-NLS-1$
        fgKeywords.put("boolean", Integer.valueOf(Token.t_boolean));
        //$NON-NLS-1$
        fgKeywords.put("byte", Integer.valueOf(Token.t_byte));
        //$NON-NLS-1$
        fgKeywords.put("extends", Integer.valueOf(Token.t_extends));
        //$NON-NLS-1$
        fgKeywords.put("final", Integer.valueOf(Token.t_final));
        //$NON-NLS-1$
        fgKeywords.put("finally", Integer.valueOf(Token.t_finally));
        //$NON-NLS-1$
        fgKeywords.put("implements", Integer.valueOf(Token.t_implements));
        //$NON-NLS-1$
        fgKeywords.put("import", Integer.valueOf(Token.t_import));
        //$NON-NLS-1$
        fgKeywords.put("interface", Integer.valueOf(Token.t_interface));
        //$NON-NLS-1$
        fgKeywords.put("instanceof", Integer.valueOf(Token.t_instanceof));
        //$NON-NLS-1$
        fgKeywords.put("native", Integer.valueOf(Token.t_native));
        //$NON-NLS-1$
        fgKeywords.put("null", Integer.valueOf(Token.t_null));
        //$NON-NLS-1$
        fgKeywords.put("package", Integer.valueOf(Token.t_package));
        //$NON-NLS-1$
        fgKeywords.put("super", Integer.valueOf(Token.t_super));
        //$NON-NLS-1$
        fgKeywords.put("synchronized", Integer.valueOf(Token.t_synchronized));
        //$NON-NLS-1$
        fgKeywords.put("throws", Integer.valueOf(Token.t_throws));
        //$NON-NLS-1$
        fgKeywords.put("transient", Integer.valueOf(Token.t_transient));
    }
}
