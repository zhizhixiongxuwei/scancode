...
public class NM {
    ...
    static public Pattern undef_pattern = null;

    static public Pattern normal_pattern = null;

    /**
     * @since 5.1
     */
    public List<String> undef_symbols;

    /**
     * @since 5.1
     */
    public List<AddressNamePair> text_symbols;

    /**
     * @since 5.1
     */
    public List<AddressNamePair> bss_symbols;
    ...
    public NM(String command, String file, boolean dynamic_only) throws IOException {
        //$NON-NLS-1$ //$NON-NLS-2$
        this(command, (dynamic_only) ? new String[] { "-C", "-D" } : null, file);
    }
