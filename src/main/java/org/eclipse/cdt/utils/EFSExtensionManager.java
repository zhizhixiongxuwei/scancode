...
public class EFSExtensionManager {
    ...
    public DefaultProvider fDefaultProvider = new DefaultProvider();

    static public EFSExtensionManager instance;

    public Map<String, EFSExtensionProvider> fSchemeToExtensionProviderMap;

    //$NON-NLS-1$
    static public String EXTENSION_ID = "EFSExtensionProvider";
    ...
    private void loadExtensions() {
        IExtensionPoint extension = Platform.getExtensionRegistry().getExtensionPoint(CCorePlugin.PLUGIN_ID, EXTENSION_ID);
        if (extension != null) {
