...
public class MachO64 implements AutoCloseable {
    ...
    public ERandomAccessFile efile;

    public MachOhdr mhdr;

    public LoadCommand[] loadcommands;

    public boolean cppFiltEnabled = true;

    public CPPFilt cppFilt;
    ...
    /* symbols from SymtabCommand */
    private Symbol[] local_symbols;

    /* local symbols from DySymtabCommand */
    private boolean dynsym = false;

    /* set if DynSymtabCommand is present */
    Line[] lines;

    /* line table */
    private ArrayList<Section> sections = new ArrayList<>();

    /* sections from SegmentCommand */
    SymtabCommand symtab;

    /* SymtabCommand that contains the symbol table */
    //$NON-NLS-1$
        ...
        protected MachOhdr() throws IOException {
            ...
            if (magic == MH_CIGAM || magic == MH_CIGAM_64) {
                ...
                while (numArchives-- > 0) {
                    ...
                    // archiveAlignment
                    efile.readIntE();
                    if ((cpuType == MachO64.MachOhdr.CPU_TYPE_I386 && //$NON-NLS-1$ //$NON-NLS-2$
                    (arch.equalsIgnoreCase("i386") || arch.equalsIgnoreCase("x86_64"))) || //$NON-NLS-1$
                    (cpuType == MachO64.MachOhdr.CPU_TYPE_POWERPC && arch.equalsIgnoreCase("ppc")) || (cpuType == MachO64.MachOhdr.CPU_TYPE_X86_64 && arch.equalsIgnoreCase("x86_64"))) {
                        //$NON-NLS-1$
    ...
    public class SegmentCommand extends LoadCommand {
        ...
        public final static int VM_PROT_READ = 0x01;

        /* read permission */
        public final static int VM_PROT_WRITE = 0x02;

        /* write permission */
        public final static int VM_PROT_EXECUTE = 0x04;
    ...
    public class Section {
        ...
        public final static int SECTION_TYP = 0x000000ff;

        /* 256 section types */
        public final static int SECTION_ATTRIBUTES = 0xffffff00;
        ...
        /* name segment this section goes in */
    ...
    public class Symbol implements Comparable<Object> {
        ...
        public final static int N_TYPE = 0x0e;
        ...
        public final static int N_BNSYM = 0x2e;
        ...
        public final static int N_ENSYM = 0x4e;
        ...
        public final static int N_PARAMS = 0x86;

        /* compiler parameters: name,,NO_SECT,0,0 */
        public final static int N_VERSION = 0x88;

        /* compiler version: name,,NO_SECT,0,0 */
        public final static int N_OLEVEL = 0x8A;
        ...
        public final static int N_LENG = 0xfe;
        ...
        /* Values of n_desc */
        public final static int REFERENCE_TYPE = 0xf;
            ...
            for (int i = 0; i < mhdr.ncmds; i++) {
                ...
                switch(cmd) {
                    ...
                    default:
                        ...
                        efile.skipBytes(len - 8);
                        //$NON-NLS-1$
                        ILog.get().warn(String.format("Mach-O load command 0x%x not handled", cmd));
                        break;
                }
            }
        }
