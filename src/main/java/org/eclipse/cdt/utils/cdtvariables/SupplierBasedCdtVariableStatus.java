...
public class SupplierBasedCdtVariableStatus extends CdtVariableStatus {
    ...
    public SupplierBasedCdtVariableStatus(int code, String message, Throwable exception, String macroName, String expression, String referencedName, IVariableContextInfo info) {
