...
public class AR implements AutoCloseable {
    ...
    public MemberHeader[] memberHeaders;
    ...
    public class ARHeader {
        ...
        private byte[] fl_magic = new byte[SAIAMAG];
    ...
    public static boolean isARHeader(byte[] ident) {
        if (ident == null || ident.length < 8 || ident[0] != '<' || ident[1] != 'b' || ident[2] != 'i' || ident[3] != 'g' || ident[4] != 'a' || ident[5] != 'f' || ident[6] != '>' || ident[7] != '\n')
            return false;
        return true;
    }
