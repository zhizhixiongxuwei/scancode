...
public class Addr32 implements IAddress, Serializable {
    ...
    static final public long MAX_ADDR = 0xffffffffL;
    ...
    static final public int BYTES_NUM = 4;
    ...
    public Addr32(byte[] addrBytes) {
        ...
        this.address = ((((long) addrBytes[0]) << 24) & 0xFF000000L) + ((((long) addrBytes[1]) << 16) & 0x00FF0000L) + ((((long) addrBytes[2]) << 8) & 0x0000FF00L) + (addrBytes[3] & 0x000000FFL);
    }
