...
public class Coff64 {
    ...
    public static class SectionHeader {
        ...
        /* "noload": allocated, relocated,
														not loaded */
        public final static int STYP_GROUP = 0x0004;

        /* "grouped": formed of input
														sections */
        ...
        /* In a minimal file or an update
        ...
        /* overlay: relocated not allocated
													or loaded */
         ...
         * @since 8.4
         */
        public static final int STYP_MEM_DISCARDABLE = 0x02000000;
        ...
        // the offset of this binary object within the file (eg archive file)
    ...
    public static class Reloc {
        ...
        /* 4 byte: Pointer to an area in raw data that represents a
							referenced address. */
        public int r_symndx;
    ...
    public static class Symbol {
        ...
        /* short, line number in auxiliary entry */
        /**
         * @since 5.4
         */
        public short n_aux_size;

        /* short, size in bytes in auxiliary entry */
        /**
         * @since 5.4
         */
        public int n_aux_fcn_size;

        /* long, size of function in bytes found in auxiliary entry */
        ...
        public Symbol(RandomAccessFile file, long offset, boolean is64Bit) throws IOException {
            ...
            if (n_numaux > 0) {
                ...
                // ignore first 4 bytes - tag index
                memory.getInt();
