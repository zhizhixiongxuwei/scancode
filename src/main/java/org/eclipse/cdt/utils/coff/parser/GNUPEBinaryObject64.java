...
public class GNUPEBinaryObject64 extends PEBinaryObject64 {
    ...
    public Addr2line autoDisposeAddr2line;

    public Addr2line symbolLoadingAddr2line;

    public CPPFilt symbolLoadingCPPFilt;
        ...
        for (Coff64.Symbol element : peSyms) {
            ...
            if (symbolLoadingAddr2line != null) {
                try {
                    ...
                    //$NON-NLS-1$
                    IPath file = (filename != null && !filename.equals("??")) ? new Path(filename) : Path.EMPTY;
