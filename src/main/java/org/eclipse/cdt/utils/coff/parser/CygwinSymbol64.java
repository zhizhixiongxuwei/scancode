 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class CygwinSymbol64 extends Symbol {
     ...
     * @param endLine
     */
    public CygwinSymbol64(CygwinPEBinaryObject64 binary, String name, int type, IAddress addr, long size, IPath sourceFile, int startLine, int endLine) {
