...
public class Dwarf implements AutoCloseable {
    ...
    /* Section names. */
    //$NON-NLS-1$
    final static public String DWARF_DEBUG_INFO = ".debug_info";

    //$NON-NLS-1$
    final static public String DWARF_DEBUG_ABBREV = ".debug_abbrev";

    //$NON-NLS-1$
    final static public String DWARF_DEBUG_ARANGES = ".debug_aranges";

    //$NON-NLS-1$
    final static public String DWARF_DEBUG_LINE = ".debug_line";

    //$NON-NLS-1$
    final static public String DWARF_DEBUG_FRAME = ".debug_frame";
    ...
    //$NON-NLS-1$
    final static String DWARF_DEBUG_STR_OFFSETS = ".debug_str_offsets";
    ...
    //$NON-NLS-1$
    final static String DWARF_DEBUG_MACRO = ".debug_macro";

    //$NON-NLS-1$
    final static String DWARF_DEBUG_TYPES = ".debug_types";

    //$NON-NLS-1$
    final static String DWARF_DEBUG_LINE_STR = ".debug_line_str";

    //$NON-NLS-1$
    final static String DWARF_GNU_DEBUGLINK = ".gnu_debuglink";

    //$NON-NLS-1$
    final static String DWARF_GNU_DEBUGALTLINK = ".gnu_debugaltlink";
    ...
    final static String[] DWARF_ALT_SCNNAMES = { DWARF_DEBUG_INFO, DWARF_DEBUG_TYPES, DWARF_DEBUG_MACRO, DWARF_DEBUG_STR };
    ...
    class Attribute {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            //$NON-NLS-1$
            sb.append("name: ").append(Long.toHexString(name));
            //$NON-NLS-1$
            sb.append(" form: ").append(Long.toHexString(form));
            //$NON-NLS-1$
            sb.append(" value: ").append(Long.toHexString(value));
            return sb.toString();
        }
    }
            ...
            if (data != null) {
                ...
                while (data.remaining() > 0) {
                    ...
                    if (printEnabled)
                        ...
                        "\tAbrev Entry: " + code + " " + Long.toHexString(entry.tag) + " " + entry.hasChildren);
                    // attributes
                    long name = 0;
                    long form = 0;
                    do {
                        ...
                        if (printEnabled)
                            ...
                            "\t\t " + Long.toHexString(name) + " " + //$NON-NLS-1$
        ...
        switch(form) {
            ...
            default:
                if (printEnabled) {
                    ...
                    //$NON-NLS-1$
                    System.out.println("Last form is " + oldForm);
                }
                break;
        }
        oldForm = form;
    ...
    void processDebugInfoEntry(IDebugEntryRequestor requestor, AbbreviationEntry entry, List<AttributeValue> list) throws IOException {
        int len = list.size();
