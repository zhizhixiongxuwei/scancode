...
public class TemplateCore {
    ...
    static public Map<TemplateInfo, TemplateCore> templateCache = new HashMap<>();
    ...
    protected TemplateCore(TemplateInfo templateInfo) throws TemplateInitializationException {
        ...
        if (descriptorURL == null)
            throw new TemplateInitializationException(//$NON-NLS-1$
            "Unable to load project template. Location URL is null for " + templateInfo.getTemplateId());
        ...
        //$NON-NLS-1$
        valueStore.put("projectType", templateInfo.getProjectType());
