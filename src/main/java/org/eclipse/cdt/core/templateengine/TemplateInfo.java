...
public class TemplateInfo {
    ...
    public Set<String> toolChainIdSet;

    private Object pagesProvider;

    /*IPagesAfterTemplateSelectionProvider*/
    ...
    /*IConfiguration This seems to be used for storing build-system specific configurations*/
    /**
     * @param templateId
     * @param projectTypeId
     * @param filterPattern
    ...
    public boolean equals(Object obj) {
        if (obj instanceof TemplateInfo) {
            ...
            return projectTypeId.equals(info.projectTypeId) && templatePath.equals(info.templatePath) && pluginId.equals(info.pluginId) && (((filterPattern == null || info.filterPattern == null) && filterPattern == info.filterPattern) || filterPattern.equals(info.filterPattern)) && ((toolChainIdSet.equals(info.toolChainIdSet))) && ((isCategory == info.isCategory));
        }
        return false;
    }
