...
public class ProcessArgument {
    ...
    //$NON-NLS-1$
    static final public String ELEM_VALUE = "value";

    //$NON-NLS-1$
    static final public String ELEM_ELEMENT = "element";

    //$NON-NLS-1$
    static final public String ELEM_SIMPLE = "simple";

    //$NON-NLS-1$
    static final public String ELEM_SIMPLE_ARRAY = "simple-array";
