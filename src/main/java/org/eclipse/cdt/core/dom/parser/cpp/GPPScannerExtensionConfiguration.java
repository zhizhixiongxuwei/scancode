...
public class GPPScannerExtensionConfiguration extends GNUScannerExtensionConfiguration {
    ...
    static final public int VERSION_4_3 = version(4, 3);

    static final public int VERSION_4_6 = version(4, 6);

    static final public int VERSION_4_7 = version(4, 7);

    static final public int VERSION_5_0 = version(5, 0);
    ...
    public GPPScannerExtensionConfiguration(CompilerType compiler, int version) {
        ...
        if (compiler == CompilerType.GCC) {
            ...
            if (version >= VERSION_8_0) {
                addKeyword(GCCKeywords.cp__has_unique_object_representations, IGCCToken.tTT_has_unique_object_representations);
