...
public abstract class AbstractScannerExtensionConfiguration implements IScannerExtensionConfiguration {
    ...
    static final public IMacro[] EMPTY_MACRO_ARRAY = new IMacro[0];

    public ArrayList<IMacro> fAddMacroList;

    public IMacro[] fAddMacros;

    public CharArrayIntMap fAddKeywords;

    public CharArrayIntMap fAddPreprocessorKeywords;
