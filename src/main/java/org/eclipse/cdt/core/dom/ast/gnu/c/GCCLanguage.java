...
public class GCCLanguage extends AbstractCLikeLanguage {
    ...
    static final public GCCParserExtensionConfiguration C_GNU_PARSER_EXTENSION = GCCParserExtensionConfiguration.getInstance();

    // Must match the id in the extension
    //$NON-NLS-1$
    public static final String ID = CCorePlugin.PLUGIN_ID + ".gcc";

    static final public GCCLanguage DEFAULT_INSTANCE = new GCCLanguage();
