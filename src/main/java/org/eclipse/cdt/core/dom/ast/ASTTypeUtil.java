...
public class ASTTypeUtil {
    ...
    //$NON-NLS-1$
    static final public String COMMA_SPACE = ", ";
    ...
    static final public int DEAULT_ITYPE_SIZE = 2;
    ...
    static final public int TYPE_STRING_LENGTH_THRESHOLD = 100000;
    ...
    private static boolean appendCVQ(StringBuilder target, boolean needSpace, final boolean isConst, final boolean isVolatile, final boolean isRestrict) {
        if (isConst) {
            if (needSpace) {
                target.append(SPACE);
            }
