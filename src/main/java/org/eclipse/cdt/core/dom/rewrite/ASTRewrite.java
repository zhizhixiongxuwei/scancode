...
public final class ASTRewrite {
    ...
    final public IASTNode fRoot;

    final public ASTModificationStore fModificationStore;

    final public ASTModification fParentMod;

    final public NodeCommentMap fCommentMap;
