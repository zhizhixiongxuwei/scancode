...
public class GCCScannerExtensionConfiguration extends GNUScannerExtensionConfiguration {
    ...
    static final public int VERSION_4_2 = version(4, 2);

    static final public int VERSION_4_7 = version(4, 7);

    static public GCCScannerExtensionConfiguration CONFIG = new GCCScannerExtensionConfiguration();

    static public GCCScannerExtensionConfiguration CONFIG_4_2 = new GCCScannerExtensionConfiguration(VERSION_4_2);

    static public GCCScannerExtensionConfiguration CONFIG_4_7 = new GCCScannerExtensionConfiguration(VERSION_4_7);
