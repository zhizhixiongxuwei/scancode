...
public class CBuilder extends IncrementalProjectBuilder {
    ...
    //$NON-NLS-1$
    static final public String ID = CCorePlugin.PLUGIN_ID + ".cBuilder";
    ...
    protected IProject[] build(int kind, Map<String, String> args, IProgressMonitor monitor) throws CoreException {
        try {
            ...
            throw new CoreException(new Status(IStatus.ERROR, CCorePlugin.PLUGIN_ID, Messages.CBuilder_ExceptionWhileBuilding, e));
        }
    }
    ...
    protected void clean(IProgressMonitor monitor) throws CoreException {
        try {
            ...
            throw new CoreException(new Status(IStatus.ERROR, CCorePlugin.PLUGIN_ID, Messages.CBuilder_ExceptionWhileBuilding2, e));
        }
    }
}
