...
public class CDefaultBuildData extends CBuildData {
    ...
    public String[] fErrorParserIDs;

    public ICOutputEntry[] fOutputEntries;

    static final public String[] EMPTY_STRING_ARRAY = new String[0];

    static final public ICOutputEntry[] EMPTY_OUTPUT_ENTRIES_ARRAY = new ICOutputEntry[0];
