...
public class UserAndDiscoveredEntryDataSerializer extends CDataSerializer {
    ...
    //$NON-NLS-1$
    static final public String DISABLED_DISCOVERED_ENTRIES = "disabledDiscoveredEntries";

    //$NON-NLS-1$
    static final public String KIND = "kind";

    //$NON-NLS-1$
    static final public String VALUE = "value";

    static public UserAndDiscoveredEntryDataSerializer fInstance;
