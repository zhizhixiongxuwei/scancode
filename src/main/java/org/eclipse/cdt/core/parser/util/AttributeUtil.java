...
public class AttributeUtil {
    ...
    //$NON-NLS-1$
    static final public String[] ATTRIBUTE_NORETURN = new String[] { "__noreturn__", StandardAttributes.NORETURN };

    static final public String[] ATTRIBUTE_NODISCARD = new String[] { //$NON-NLS-1$
    "warn_unused_result", StandardAttributes.NODISCARD };
