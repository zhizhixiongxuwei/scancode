...
public class QualifiedTypeName implements IQualifiedTypeName {
    ...
    static final public String[] NO_SEGMENTS = {};

    //$NON-NLS-1$
    static final public String EMPTY_STRING = "";

    static final public int INITIAL_SEGMENT_LENGTH = 12;

    static final public int HASH_INIT = 17;

    static final public int HASH_MULTIPLIER = 37;
