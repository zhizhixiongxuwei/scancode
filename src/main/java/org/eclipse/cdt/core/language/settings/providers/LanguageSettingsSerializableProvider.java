...
public class LanguageSettingsSerializableProvider extends LanguageSettingsBaseProvider implements ILanguageSettingsBroadcastingProvider {
    ...
    static final public String ATTR_ID = LanguageSettingsProvidersSerializer.ATTR_ID;

    static final public String ATTR_NAME = LanguageSettingsProvidersSerializer.ATTR_NAME;

    static final public String ATTR_CLASS = LanguageSettingsProvidersSerializer.ATTR_CLASS;

    static final public String ELEM_PROVIDER = LanguageSettingsProvidersSerializer.ELEM_PROVIDER;

    static final public String ELEM_LANGUAGE_SCOPE = LanguageSettingsProvidersSerializer.ELEM_LANGUAGE_SCOPE;
    ...
    public IStatus serializeLanguageSettings(ICConfigurationDescription cfgDescription) {
        ...
        try {
            ...
            status = new Status(IStatus.ERROR, CCorePlugin.PLUGIN_ID, IStatus.ERROR, "Error serializing language settings", //$NON-NLS-1$
            e);
