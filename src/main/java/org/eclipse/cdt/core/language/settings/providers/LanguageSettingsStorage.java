...
public class LanguageSettingsStorage implements Cloneable {
     ...
     */
    public Map<String, Map<String, List<ICLanguageSettingEntry>>> // languageId
    // resource project path
    fStorage = new HashMap<>();
     ...
     */
    static public WeakHashSet<List<ICLanguageSettingEntry>> listPool = new WeakHashSetSynchronized<>();
