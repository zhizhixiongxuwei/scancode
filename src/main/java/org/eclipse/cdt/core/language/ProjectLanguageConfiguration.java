...
public class ProjectLanguageConfiguration {
    ...
    //$NON-NLS-1$
    static final public String ALL_CONFIGURATIONS = "";

    /**
     * Project-wide content type mappings (Configuration ID -> (Content Type ID -> Language ID)).
     */
    public Map<String, Map<String, String>> fConfigurationContentTypeMappings;

    /**
     * Per-file mappings (Path -> (Configuration ID -> Language ID)).
     */
    public Map<String, Map<String, String>> fFileConfigurationMappings;
