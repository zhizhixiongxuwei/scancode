...
public class ScannerInfo implements IExtendedScannerInfo {
    ...
    final public Map<String, String> fMacroMap;

    final public String[] fSystemIncludePaths;

    final public String[] fMacroFiles;

    final public String[] fIncludeFiles;

    final public String[] fLocalIncludePaths;

    final static String[] EMPTY_ARRAY_STRING = new String[0];

    protected ScannerInfo(String[] systemIncludePaths, String[] localIncludePaths, String[] includeFiles, Map<String, String> macroMap, String[] macroFiles) {
