...
public class InternalCompletionProposal extends CompletionProposal {
    ...
    static public Object NO_ATTACHED_SOURCE = new Object();

    public CompletionEngine completionEngine;

    public NameLookup nameLookup;

    public char[] declarationPackageName;

    public char[] declarationTypeName;
    ...
    protected char[][] findConstructorParameterNames(char[] declaringTypePackageName, char[] declaringTypeName, char[] selector, char[][] paramTypeNames) {
        ...
        if (cachedType != null) {
            ...
            NameLookup.Answer answer = this.nameLookup.findType(new String(declaringTypeName), new String(declaringTypePackageName), false, NameLookup.ACCEPT_CLASSES & NameLookup.ACCEPT_INTERFACES, true, /* consider secondary types */
        ...
        if (type != null) {
            ...
            try {
                ...
                if (this.hasNoParameterNamesFromIndex) {
                    ...
                    if (packageFragmentRoot.isArchive() || getOpenedBinaryTypesCount() < getOpenedBinaryTypesThreshold()) {
    ...
    public void setRelevance(int rating) {
        if (rating <= 0) {
            //$NON-NLS-1$
            throw new IllegalArgumentException("rating <=0: " + rating);
        }
