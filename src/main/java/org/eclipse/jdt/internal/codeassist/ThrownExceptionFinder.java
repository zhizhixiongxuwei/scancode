...
public class ThrownExceptionFinder extends ASTVisitor {
    ...
    public SimpleSet thrownExceptions;

    public Stack exceptionsStack;

    public SimpleSet caughtExceptions;

    public SimpleSet discouragedExceptions;
            ...
            if (catchArguments[i].type instanceof UnionTypeReference) {
                ...
                for (TypeReference ref : unionTypeReference.typeReferences) {
                    ...
                    if ((caughtException instanceof ReferenceBinding) && caughtException.isValidBinding()) {
                        // might be null when its the completion node
