...
public class CompletionNodeFound extends RuntimeException {
    ...
    // backward compatible
    static final public long serialVersionUID = 6981437684184091462L;
    ...
    public <T> T throwOrDeferAndReturn(Supplier<T> value) {
        ...
        if (this.scope != null) {
            ...
            if (enclosingReceiverType != null && !enclosingReceiverType.isLocalType() && (enclosingReceiverType.original().tagBits & TagBits.AreFieldsComplete) != TagBits.AreFieldsComplete) {
