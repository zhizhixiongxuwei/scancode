...
public class UnresolvedReferenceNameFinder extends ASTVisitor {
    ...
    static final public int MAX_LINE_COUNT = 100;

    static final public int FAKE_BLOCKS_COUNT = 20;
    ...
    public UnresolvedReferenceNameRequestor requestor;

    final public CompletionEngine completionEngine;

    final public CompletionParser parser;
    ...
    private MethodDeclaration findAfter(char[] startWith, Scope s, int from, int to, int maxLineCount, boolean outsideEnclosingBlock, char[][] discouragedNames, UnresolvedReferenceNameRequestor nameRequestor) {
        ...
        // limit (from,end) already defines what we want to look at.
        this.parser.cursorLocation = Integer.MAX_VALUE;
