...
public class MissingTypesGuesser extends ASTVisitor {
    ...
    final public CompletionEngine.CompletionProblemFactory problemFactory;

    final public SearchableEnvironment nameEnvironment;

    public HashMap substituedTypes;

    public HashMap originalTypes;
