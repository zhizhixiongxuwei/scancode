...
public class SourceElementNotifier {
    ...
    public char[][] superTypeNames;

    public int nestedTypeIndex;
    ...
    private void visitIfNeeded(Block block) {
        if (this.localDeclarationVisitor != null) {
            if (block.statements != null) {
                ...
                for (int i = 0; i < statementsLength; i++) block.statements[i].traverse(this.localDeclarationVisitor, block.scope);
            }
        }
    }
}
