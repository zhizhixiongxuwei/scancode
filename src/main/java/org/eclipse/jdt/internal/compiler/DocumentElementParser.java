...
public class DocumentElementParser extends Parser {
    ...
    public int lastFieldEndPosition;

    public int lastFieldBodyEndPosition;

    public int typeStartPosition;

    public long selectorSourcePositions;
 ...
 */
    ...
    protected void consumeClassDeclaration() {
        ...
        this.requestor.// '}' is the end of the body
        exitClass(// '}' is the end of the body
 ...
 */
	...
	*/
    ...
    protected void consumeInstanceOfExpression() {
        // skip declarationSourceStart of modifiers
        this.intPtr--;
 ...
 */
    ...
    protected void consumeInterfaceDeclaration() {
        ...
        this.requestor.// the '}' is the end of the body
        exitInterface(// the '}' is the end of the body
        this.endStatementPosition, ((TypeDeclaration) this.astStack[this.astPtr]).declarationSourceEnd);
    }
