...
public class SourceTypeElementInfo extends AnnotatableInfo implements ISourceType {
    ...
    static final public ISourceImport[] NO_IMPORTS = new ISourceImport[0];

    static final public InitializerElementInfo[] NO_INITIALIZERS = new InitializerElementInfo[0];

    static final public SourceField[] NO_FIELDS = new SourceField[0];

    static final public SourceMethod[] NO_METHODS = new SourceMethod[0];

    static final public SourceType[] NO_TYPES = new SourceType[0];
