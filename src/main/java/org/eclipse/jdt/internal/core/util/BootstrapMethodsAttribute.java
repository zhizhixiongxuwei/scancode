...
public class BootstrapMethodsAttribute extends ClassFileAttribute implements IBootstrapMethodsAttribute {
    ...
    static final public IBootstrapMethodsEntry[] NO_ENTRIES = new IBootstrapMethodsEntry[0];

    public IBootstrapMethodsEntry[] entries;

    final public int numberOfBootstrapMethods;
