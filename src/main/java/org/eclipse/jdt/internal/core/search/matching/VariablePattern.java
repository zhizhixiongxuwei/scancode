...
public abstract class VariablePattern extends JavaSearchPattern {
    ...
    public boolean findDeclarations = false;

    public boolean findReferences = false;
    ...
    public final static int FINE_GRAIN_MASK = IJavaSearchConstants.SUPER_REFERENCE | IJavaSearchConstants.QUALIFIED_REFERENCE | IJavaSearchConstants.THIS_REFERENCE | IJavaSearchConstants.IMPLICIT_THIS_REFERENCE;
