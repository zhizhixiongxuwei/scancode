...
public class EntryResult {
    ...
    final public char[] word;

    public Object[] documentTables;

    public SimpleSet documentNames;
    ...
    public String[] getDocumentNames(Index index) throws java.io.IOException {
        if (this.documentTables != null) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                int[] numbers = index.diskIndex.readDocumentNumbers(offset);
                for (int number : numbers) addDocumentName(index.diskIndex.readDocumentName(number));
            }
        }
        if (this.documentNames == null)
        ...
        for (Object value : values) if (value != null)
