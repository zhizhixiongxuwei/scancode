...
public class RuntimeVisibleTypeAnnotationsAttribute extends ClassFileAttribute implements IRuntimeVisibleTypeAnnotationsAttribute {
    ...
    static final public IExtendedAnnotation[] NO_ENTRIES = new IExtendedAnnotation[0];

    final public int extendedAnnotationsNumber;

    public IExtendedAnnotation[] extendedAnnotations;
