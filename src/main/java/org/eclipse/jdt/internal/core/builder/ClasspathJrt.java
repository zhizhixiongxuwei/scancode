...
public class ClasspathJrt extends ClasspathLocation implements IMultiModuleEntry {
    ...
    final static public Map<String, Map<String, IModule>> modulesCache = new ConcurrentHashMap<>();

    // keep for equals
    final public String zipFilename;

    final public JrtFileSystem jrtFileSystem;

    static final public Set<String> NO_LIMIT_MODULES = Collections.emptySet();
    ...
    protected Collection<String> selectModules(Set<String> keySet, Collection<String> limitModules) {
        ...
        for (String mod : rootModules) addRequired(mod, allModules);
        return allModules;
    }
