...
public class DefaultStackMapFrame extends ClassFileStruct implements IStackMapFrame {
    ...
    static final public IVerificationTypeInfo[] EMPTY_LOCALS_OR_STACK_ITEMS = new IVerificationTypeInfo[0];

    public int readOffset;

    final public int numberOfLocals;

    final public int numberOfStackItems;

    public IVerificationTypeInfo[] locals;
