...
public class MethodParametersAttribute extends ClassFileAttribute implements IMethodParametersAttribute {
    ...
    static final public char[][] NO_NAMES = new char[0][];

    static final public short[] NO_ACCES_FLAGS = new short[0];

    final public int numberOfEntries;

    final public char[][] names;

    final public short[] accessFlags;
