 ...
 */
final public class OrderPreservingImportAdder implements ImportAdder {
    ...
    public List<ImportName> addImports(Collection<ImportName> existingImports, Collection<ImportName> importsToAdd) {
        ...
        Map<ImportName, AdjacentImports> adjacentNewImports = determineAdjacentNewImports(new ArrayList<>(existingImports), sortedNewImports);
