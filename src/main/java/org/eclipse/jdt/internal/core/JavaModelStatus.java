...
public class JavaModelStatus extends Status implements IJavaModelStatus, IJavaModelStatusConstants {
     ...
     */
    public IJavaElement[] elements = new IJavaElement[0];
     ...
     * Empty children
     */
    final static public IStatus[] NO_CHILDREN = new IStatus[] {};

    public IStatus[] children = NO_CHILDREN;
            ...
            switch(getCode()) {
                ...
                case INVALID_PATH:
                    if (this.string != null) {
                        ...
                        return Messages.bind(Messages.status_invalidPath, //$NON-NLS-1$
                        new String[] { getPath() == null ? "null" : getPath().toString() });
                    }
