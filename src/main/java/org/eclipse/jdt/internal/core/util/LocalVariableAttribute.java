...
public class LocalVariableAttribute extends ClassFileAttribute implements ILocalVariableAttribute {
    ...
    static final public ILocalVariableTableEntry[] NO_ENTRIES = new ILocalVariableTableEntry[0];

    final public int localVariableTableLength;

    public ILocalVariableTableEntry[] localVariableTable;
