...
public class OrLocator extends PatternLocator {
    ...
    public PatternLocator[] patternLocators;
    ...
    public void initializePolymorphicSearch(MatchLocator locator) {
        for (PatternLocator patternLocator : this.patternLocators) patternLocator.initializePolymorphicSearch(locator);
    }
    ...
    protected int matchContainer() {
        int result = 0;
        for (PatternLocator patternLocator : this.patternLocators) result |= patternLocator.matchContainer();
        return result;
    }
