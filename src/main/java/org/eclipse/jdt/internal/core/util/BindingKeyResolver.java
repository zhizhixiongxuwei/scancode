...
public class BindingKeyResolver extends BindingKeyParser {
    ...
    public void consumeLocalType(char[] uniqueKey) {
        ...
        for (LocalTypeBinding localTypeBinding : this.parsedUnit.localTypes.values()) {
            if (CharOperation.equals(uniqueKey, localTypeBinding.computeUniqueKey(false))) {
        ...
        switch(kind) {
            ...
            case Wildcard.SUPER:
                ...
                if (boundBinding instanceof TypeBinding) {
                    this.typeBinding = this.environment.createWildcard((ReferenceBinding) this.typeBinding, this.wildcardRank, (TypeBinding) boundBinding, null, /*no extra bound*/
                    kind);
                } else {
                    this.typeBinding = null;
                }
            ...
            case Wildcard.UNBOUND:
                this.typeBinding = this.environment.createWildcard((ReferenceBinding) this.typeBinding, this.wildcardRank, null, /*no bound*/
                null, /*no extra bound*/
                kind);
                break;
        }
