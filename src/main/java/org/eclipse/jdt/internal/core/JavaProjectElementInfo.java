                ...
                for (int i = 0; i < length; i++) {
                    ...
                    switch(res.getType()) {
                        case IResource.FILE:
                            ...
                            if (isClasspathResolved && isClasspathEntryOrOutputLocation(resFullPath, res.getLocation(), /* see https://bugs.eclipse.org/bugs/show_bug.cgi?id=244406 */
        ...
        if (allPkgFragmentsCache == null) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (fragmentsCache == null) {
                    // see https://bugs.eclipse.org/bugs/show_bug.cgi?id=183833
