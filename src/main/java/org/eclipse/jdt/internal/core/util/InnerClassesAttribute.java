...
public class InnerClassesAttribute extends ClassFileAttribute implements IInnerClassesAttribute {
    ...
    static final public IInnerClassesAttributeEntry[] NO_ENTRIES = new IInnerClassesAttributeEntry[0];

    final public int numberOfClasses;

    public IInnerClassesAttributeEntry[] entries;
