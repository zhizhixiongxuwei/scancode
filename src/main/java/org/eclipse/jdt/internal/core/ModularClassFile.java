...
public class ModularClassFile extends AbstractClassFile implements IModularClassFile {
    ...
    public void codeComplete(int offset, CompletionRequestor requestor, WorkingCopyOwner owner, IProgressMonitor monitor) throws JavaModelException {
        ...
        if (source != null) {
            BasicCompilationUnit cu = new BasicCompilationUnit(getSource().toCharArray(), null, TypeConstants.MODULE_INFO_FILE_NAME_STRING, // use project to retrieve corresponding .java IFile
            getJavaProject());
    ...
    static final public ClassFileInfo notExists = new ClassFileInfo();
