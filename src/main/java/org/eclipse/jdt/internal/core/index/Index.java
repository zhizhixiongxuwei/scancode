...
public class Index {
    ...
    static final public char DEFAULT_SEPARATOR = '/';
     ...
     */
    static final int MATCH_RULE_INDEX_MASK = SearchPattern.R_EXACT_MATCH | SearchPattern.R_PREFIX_MATCH | SearchPattern.R_PATTERN_MATCH | SearchPattern.R_REGEXP_MATCH | SearchPattern.R_CASE_SENSITIVE | SearchPattern.R_CAMELCASE_MATCH | SearchPattern.R_CAMELCASE_SAME_PART_COUNT_MATCH | SearchPattern.R_SUBSTRING_MATCH | SearchPattern.R_SUBWORD_MATCH;
    ...
    public String[] queryDocumentNames(String substring) throws IOException {
        ...
        for (Object path : paths) if (path != null)
    ...
    public List<IndexQualifier> getMetaIndexQualifications() throws IOException {
        ...
        try {
            ...
            for (char[] category : IIndexConstants.META_INDEX_CATEGORIES) {
                ...
                EntryResult[] results = query(new char[][] { category }, null, SearchPattern.R_EXACT_MATCH | SearchPattern.R_CASE_SENSITIVE);
                if (results != null) {
                    // minimize array resize
                    qualifiers.ensureCapacity(results.length);
