...
public class PermittedSubclassesAttribute extends ClassFileAttribute implements IPermittedSubclassesAttribute {
    ...
    static final public IPermittedSubclassesAttributeEntry[] NO_ENTRIES = new IPermittedSubclassesAttributeEntry[0];

    final public int permittedSubclassesCount;

    public IPermittedSubclassesAttributeEntry[] entries;
