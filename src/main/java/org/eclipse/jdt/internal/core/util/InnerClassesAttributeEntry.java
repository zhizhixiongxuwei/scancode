...
public class InnerClassesAttributeEntry extends ClassFileStruct implements IInnerClassesAttributeEntry {
    ...
    final public int innerClassNameIndex;

    final public int outerClassNameIndex;

    final public int innerNameIndex;

    public char[] innerClassName;

    public char[] outerClassName;
