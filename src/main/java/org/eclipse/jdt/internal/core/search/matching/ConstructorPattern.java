...
public class ConstructorPattern extends JavaSearchPattern {
    ...
    public boolean findDeclarations = true;

    public boolean findReferences = true;
    ...
    public final static int FINE_GRAIN_MASK = IJavaSearchConstants.SUPER_REFERENCE | IJavaSearchConstants.QUALIFIED_REFERENCE | IJavaSearchConstants.THIS_REFERENCE | IJavaSearchConstants.IMPLICIT_THIS_REFERENCE | IJavaSearchConstants.METHOD_REFERENCE_EXPRESSION;
    ...
    public static char[] createDefaultDeclarationIndexKey(char[] typeName, char[] packageName, int typeModifiers, int extraFlags) {
        return createDeclarationIndexKey(typeName, // used to identify default constructor
        -1, null, null, null, //
        0, packageName, typeModifiers, extraFlags);
    }
    ...
    public ConstructorPattern(char[] declaringSimpleName, char[] declaringQualification, char[][] parameterQualifications, char[][] parameterSimpleNames, int limitTo, int matchRule, boolean isStaticInnerConstructor) {
        this(matchRule);
 ...
 */
    public ConstructorPattern(char[] declaringSimpleName, char[] declaringQualification, char[][] parameterQualifications, char[][] parameterSimpleNames, String[] parameterSignatures, IMethod method, int limitTo, int matchRule) {
        this(declaringSimpleName, declaringQualification, parameterQualifications, parameterSimpleNames, limitTo, matchRule, isStaticInnerConstructor(method));
        // Set flags
        try {
 ...
 */
    public ConstructorPattern(char[] declaringSimpleName, char[] declaringQualification, String declaringSignature, char[][] parameterQualifications, char[][] parameterSimpleNames, String[] parameterSignatures, char[][] arguments, int limitTo, int matchRule) {
        this(declaringSimpleName, declaringQualification, parameterQualifications, parameterSimpleNames, limitTo, matchRule, false);
        // Store type signature and arguments for declaring type
