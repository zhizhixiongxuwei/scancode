...
public abstract class OverflowingLRUCache<K, V> extends LRUCache<K, V> {
    ...
    public Enumeration<V> elements() {
        ...
        LRUCacheEnumerator.LRUEnumeratorElement<V> head = new LRUCacheEnumerator.LRUEnumeratorElement<>(this.entryQueue.value);
