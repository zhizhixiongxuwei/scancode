...
public class IndexingParser extends SourceElementParser {
    ...
    public SingleNameReference singleNameReference = new SingleNameReference(CharOperation.NO_CHAR, 0);

    public QualifiedNameReference qualifiedNameReference = new QualifiedNameReference(CharOperation.NO_CHAR_CHAR, new long[0], 0, 0);

    public ImportReference importReference = new ImportReference(CharOperation.NO_CHAR_CHAR, new long[1], false, 0);
