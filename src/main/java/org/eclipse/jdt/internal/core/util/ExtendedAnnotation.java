...
public class ExtendedAnnotation extends ClassFileStruct implements IExtendedAnnotation {
    ...
    static final public IAnnotationComponent[] NO_ENTRIES = new IAnnotationComponent[0];

    final static public int[][] NO_TYPEPATH = new int[0][0];

    final static public ILocalVariableReferenceInfo[] NO_LOCAL_VARIABLE_TABLE_ENTRIES = new ILocalVariableReferenceInfo[0];

    final public int targetType;
