...
public class WeakHashSet<T> {
    ...
    public HashableWeakReference<T>[] values;
    ...
    public ReferenceQueue<T> referenceQueue = new ReferenceQueue<>();
    ...
    private void rehash() {
        ...
        WeakHashSet<T> newHashSet = new WeakHashSet<>(this.elementSize * 2);
        newHashSet.referenceQueue = this.referenceQueue;
        HashableWeakReference<T> currentValue;
        for (HashableWeakReference<T> value : this.values) if ((currentValue = value) != null)
