...
public class BindingMap<V> {
    ...
    final public Map<TypeBinding, V> identityMap = new IdentityHashMap<>();

    public Object[] mapIdToValue = new Object[0];

    final public Set<TypeBinding> bindingsWithoutAnId = new HashSet<>();
