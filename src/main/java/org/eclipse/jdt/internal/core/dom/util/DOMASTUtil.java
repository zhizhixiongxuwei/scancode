...
public class DOMASTUtil {
    ...
    static final public String[] AST_COMPLIANCE_MAP = { //$NON-NLS-1$ //$NON-NLS-2$
    "-1", //$NON-NLS-1$ //$NON-NLS-2$
    "-1", //$NON-NLS-1$ //$NON-NLS-2$
    JavaCore.VERSION_1_2, //$NON-NLS-1$ //$NON-NLS-2$
    JavaCore.VERSION_1_3, //$NON-NLS-1$ //$NON-NLS-2$
    JavaCore.VERSION_1_7, JavaCore.VERSION_1_7, JavaCore.VERSION_1_7, JavaCore.VERSION_1_7, JavaCore.VERSION_1_8, JavaCore.VERSION_9, JavaCore.VERSION_10, JavaCore.VERSION_11, JavaCore.VERSION_12, JavaCore.VERSION_13, JavaCore.VERSION_14, JavaCore.VERSION_15, JavaCore.VERSION_16, JavaCore.VERSION_17, JavaCore.VERSION_18, JavaCore.VERSION_19, JavaCore.VERSION_20, JavaCore.VERSION_21, JavaCore.VERSION_22, JavaCore.VERSION_23, JavaCore.VERSION_24, JavaCore.VERSION_25 };
