...
public class AnnotationComponentValue extends ClassFileStruct implements IAnnotationComponentValue {
    ...
    static final public IAnnotationComponentValue[] NO_VALUES = new AnnotationComponentValue[0];

    public IAnnotationComponentValue[] annotationComponentValues;

    public IAnnotation annotationValue;

    public IConstantPoolEntry classInfo;

    public int classFileInfoIndex;
