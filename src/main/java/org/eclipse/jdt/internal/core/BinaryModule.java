...
public class BinaryModule extends BinaryMember implements AbstractModule {
    ...
    public IAnnotation[] getAnnotations() throws JavaModelException {
        ...
        // TODO: kludge to avoid duplication of real annotation and tagBit induced standard annotation
        long tagBits = moduleInfo.getTagBits() & ~TagBits.AnnotationDeprecated;
