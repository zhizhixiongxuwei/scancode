...
public class ClassFileReader extends ClassFileStruct implements IClassFileReader {
    ...
    static final public IFieldInfo[] NO_FIELD_INFOS = new IFieldInfo[0];

    static final public char[][] NO_INTERFACES_NAMES = CharOperation.NO_CHAR_CHAR;

    static final public IMethodInfo[] NO_METHOD_INFOS = new IMethodInfo[0];
