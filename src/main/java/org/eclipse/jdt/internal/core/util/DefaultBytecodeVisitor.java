...
public class DefaultBytecodeVisitor implements IBytecodeVisitor {
    ...
    //$NON-NLS-1$
    static final public String EMPTY_CLASS_NAME = "\"\"";

    //$NON-NLS-1$
    static final public String EMPTY_LOCAL_NAME = "";

    static final public int T_BOOLEAN = 4;

    static final public int T_CHAR = 5;

    static final public int T_FLOAT = 6;
    ...
    public void _ldc_w(int pc, int index, IConstantPoolEntry constantPoolEntry) {
        ...
        switch(constantPoolEntry.getKind()) {
            ...
            case IConstantPoolConstant.CONSTANT_MethodType:
                appendConstantMethodType(this.buffer, Messages.classformat_ldc_w_methodhandle, IOpcodeMnemonics.LDC_W, index, constantPoolEntry);
                break;
            case IConstantPoolConstant.CONSTANT_MethodHandle:
                appendConstantMethodHandle(this.buffer, Messages.classformat_ldc_w_methodhandle, IOpcodeMnemonics.LDC_W, index, constantPoolEntry);
                break;
        }
        writeNewLine();
    }
    ...
    public void _ldc(int pc, int index, IConstantPoolEntry constantPoolEntry) {
        ...
        switch(constantPoolEntry.getKind()) {
            ...
            case IConstantPoolConstant.CONSTANT_Class:
                ...
                break;
            case IConstantPoolConstant.CONSTANT_MethodType:
                appendConstantMethodType(this.buffer, Messages.classformat_ldc_w_methodhandle, IOpcodeMnemonics.LDC, index, constantPoolEntry);
                break;
            case IConstantPoolConstant.CONSTANT_MethodHandle:
                appendConstantMethodHandle(this.buffer, Messages.classformat_ldc_w_methodhandle, IOpcodeMnemonics.LDC, index, constantPoolEntry);
                break;
            case IConstantPoolConstant.CONSTANT_Dynamic:
                appendConstantDynamic(this.buffer, Messages.classformat_ldc_w_dynamic, IOpcodeMnemonics.LDC, index, constantPoolEntry);
                break;
        }
        writeNewLine();
    }

    private StringBuilder appendConstantMethodType(StringBuilder s, String messageKind, int opcode, int index, IConstantPoolEntry constantPoolEntry) {
    ...
    private StringBuilder appendConstantMethodHandle(StringBuilder s, String messageKind, int opcode, int index, IConstantPoolEntry constantPoolEntry) {
    ...
    private StringBuilder appendConstantDynamic(StringBuilder s, String messageKind, int opcode, int index, IConstantPoolEntry entry) {
        return s.append(Messages.bind(messageKind, new String[] { OpcodeStringValues.BYTECODE_NAMES[opcode], Integer.toString(index), Integer.toString(((IConstantPoolEntry2) entry).getBootstrapMethodAttributeIndex()), new String(entry.getFieldName()), returnClassName(Signature.toCharArray(entry.getFieldDescriptor())) }));
    }
    ...
    public void _ldc2_w(int pc, int index, IConstantPoolEntry constantPoolEntry) {
        ...
        switch(constantPoolEntry.getKind()) {
            ...
            case IConstantPoolConstant.CONSTANT_Double:
                ...
                break;
            case IConstantPoolConstant.CONSTANT_MethodType:
                appendConstantMethodType(this.buffer, Messages.classformat_ldc_w_methodhandle, IOpcodeMnemonics.LDC2_W, index, constantPoolEntry);
                break;
            case IConstantPoolConstant.CONSTANT_MethodHandle:
                appendConstantMethodHandle(this.buffer, Messages.classformat_ldc_w_methodhandle, IOpcodeMnemonics.LDC2_W, index, constantPoolEntry);
                break;
            case IConstantPoolConstant.CONSTANT_Dynamic:
                appendConstantDynamic(this.buffer, Messages.classformat_ldc_w_dynamic, IOpcodeMnemonics.LDC2_W, index, constantPoolEntry);
                break;
        }
        writeNewLine();
    }
