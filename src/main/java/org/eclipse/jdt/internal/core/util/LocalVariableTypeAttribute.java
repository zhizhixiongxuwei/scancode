...
public class LocalVariableTypeAttribute extends ClassFileAttribute implements ILocalVariableTypeTableAttribute {
    ...
    static final public ILocalVariableTypeTableEntry[] NO_ENTRIES = new ILocalVariableTypeTableEntry[0];

    final public int localVariableTypeTableLength;

    public ILocalVariableTypeTableEntry[] localVariableTypeTableEntries;
