...
public class IndexNamesRegistry {
    ...
    final public File savedIndexNamesFile;

    final public Job writeJob;

    final public IPath javaPluginWorkingLocation;

    final public Object queueMutex = new Object();
