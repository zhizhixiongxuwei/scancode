...
public final class JavaCore extends Plugin {
    ...
    static final public IResource[] NO_GENERATED_RESOURCES = new IResource[0];

    static public Plugin JAVA_CORE_PLUGIN = null;
    ...
    COMPILER_CODEGEN_INLINE_JSR_BYTECODE = PLUGIN_ID + ".compiler.codegen.inlineJsrBytecode";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_TERMINAL_DEPRECATION = PLUGIN_ID + ".compiler.problem.terminalDeprecation";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_MEMBER_OF_DEPRECATED_TYPE = "org.eclipse.jdt.core.compiler.problem.memberOfDeprecatedTypeNotDeprecated";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_UNUSED_LAMBDA_PARAMETER = PLUGIN_ID + ".compiler.problem.unusedLambdaParameter";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_ANNOTATION_RESOURCE_ANALYSIS = PLUGIN_ID + ".compiler.annotation.resourceanalysis";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_OWNING_ANNOTATION_NAME = PLUGIN_ID + ".compiler.annotation.owning";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_NOTOWNING_ANNOTATION_NAME = PLUGIN_ID + ".compiler.annotation.notowning";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_RECOMMENDED_RESOURCE_MANAGEMENT = PLUGIN_ID + ".compiler.problem.insufficientResourceAnalysis";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_INCOMPATIBLE_OWNING_CONTRACT = PLUGIN_ID + ".compiler.problem.incompatibleOwningContract";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_UNLIKELY_COLLECTION_METHOD_ARGUMENT_TYPE = PLUGIN_ID + ".compiler.problem.unlikelyCollectionMethodArgumentType";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_UNLIKELY_COLLECTION_METHOD_ARGUMENT_TYPE_STRICT = PLUGIN_ID + ".compiler.problem.unlikelyCollectionMethodArgumentTypeStrict";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_UNLIKELY_EQUALS_ARGUMENT_TYPE = PLUGIN_ID + ".compiler.problem.unlikelyEqualsArgumentType";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_API_LEAKS = PLUGIN_ID + ".compiler.problem.APILeak";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_UNSTABLE_AUTO_MODULE_NAME = PLUGIN_ID + ".compiler.problem.unstableAutoModuleName";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_SUPPRESS_WARNINGS_NOT_FULLY_ANALYSED = PLUGIN_ID + ".compiler.problem.suppressWarningsNotFullyAnalysed";
     ...
     */
    //$NON-NLS-1$
    public static final String CORE_JAVA_BUILD_EXTERNAL_ANNOTATIONS_FROM_ALL_LOCATIONS = PLUGIN_ID + ".builder.annotationPath.allLocations";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_ANNOTATED_TYPE_ARGUMENT_TO_UNANNOTATED = JavaCore.PLUGIN_ID + ".compiler.problem.annotatedTypeArgumentToUnannotated";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_RELEASE = PLUGIN_ID + ".compiler.release";
     ...
     */
    //$NON-NLS-1$
    public static final String CORE_MAIN_ONLY_PROJECT_HAS_TEST_ONLY_DEPENDENCY = PLUGIN_ID + ".classpath.mainOnlyProjectHasTestOnlyDependency";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_ENABLE_PREVIEW_FEATURES = PLUGIN_ID + ".compiler.problem.enablePreviewFeatures";
     ...
     */
    //$NON-NLS-1$
    public static final String COMPILER_PB_REPORT_PREVIEW_FEATURES = PLUGIN_ID + ".compiler.problem.reportPreviewFeatures";
     ...
     */
    //$NON-NLS-1$"
    public static final String COMPILER_IGNORE_UNNAMED_MODULE_FOR_SPLIT_PACKAGE = PLUGIN_ID + ".compiler.ignoreUnnamedModuleForSplitPackage";
     ...
     */
    //$NON-NLS-1$
    public static final String CODEASSIST_SUBWORD_MATCH = PLUGIN_ID + ".codeComplete.subwordMatch";
     ...
     */
    //$NON-NLS-1$
    public static final String VERSION_24 = "24";
     ...
     */
    //$NON-NLS-1$
    public static final String VERSION_25 = "25";
     ...
     */
    //$NON-NLS-1$
    public static final String VERSION_26 = "26";
    ...
    private static final List<String> allVersions = Collections.unmodifiableList(Arrays.asList(VERSION_CLDC_1_1, VERSION_1_1, VERSION_1_2, VERSION_1_3, VERSION_1_4, VERSION_1_5, VERSION_1_6, VERSION_1_7, VERSION_1_8, VERSION_9, VERSION_10, VERSION_11, VERSION_12, VERSION_13, VERSION_14, VERSION_15, VERSION_16, VERSION_17, VERSION_18, VERSION_19, VERSION_20, VERSION_21, VERSION_22, VERSION_23, VERSION_24, VERSION_25));
    ...
    private static void verbose_failed_to_instanciate_container_initializer(String containerID, IConfigurationElement configurationElement, CoreException e) {
        ...
        configurationElement.getAttribute("class"), e);
    }
    ...
    private static void verbose_triggering_variable_initialization_invocation_trace() {
        trace(//$NON-NLS-1$
        "CPVariable INIT - triggering initialization\n" + "	invocation trace:", //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private static void getGeneratedResource(ICompilationUnit unit, IContainer container, State state, int rootPathSegmentCounts, ArrayList collector) {
        ...
        if (typeNames != null) {
            ...
            for (char[] typeName : typeNames) {
                //$NON-NLS-1$
                IPath localPath = path.append(new String(typeName) + ".class");
    ...
    public static ICompilationUnit[] getWorkingCopies(WorkingCopyOwner owner) {
        ...
        if (owner == null)
            owner = DefaultWorkingCopyOwner.PRIMARY;
        ICompilationUnit[] result = manager.getWorkingCopies(owner, false);
        if (result == null)
    ...
    public static void initializeAfterLoad(IProgressMonitor monitor) throws CoreException {
        ...
        try {
            ...
            if (manager.forceBatchInitializations(true)) {
                // if no other thread has started the batch container initializations
                // force the batch initialization
                manager.getClasspathContainer(Path.EMPTY, null);
            } else {
                // else wait for the batch initialization to finish
        ...
        try {
            ...
            model.refreshExternalArchives(null, /*refresh all projects*/
        ...
        if (!newVersionNumber.equals(versionNumber)) {
            ...
            if (JavaBuilder.DEBUG) {
                //$NON-NLS-1$
                trace("Build state version number has changed");
            }
                ...
                public void run(IProgressMonitor progressMonitor2) throws CoreException {
                    for (IJavaProject project : projects) {
                        try {
                            if (JavaBuilder.DEBUG) {
                                //$NON-NLS-1$
                                trace("Touching " + project.getElementName());
                            }
    ...
    public static IClasspathEntry newContainerEntry(IPath containerPath) {
        return newContainerEntry(containerPath, ClasspathEntry.NO_ACCESS_RULES, ClasspathEntry.NO_EXTRA_ATTRIBUTES, false);
    }
    ...
    public static IClasspathEntry newLibraryEntry(IPath path, IPath sourceAttachmentPath, IPath sourceAttachmentRootPath) {
        return newLibraryEntry(path, sourceAttachmentPath, sourceAttachmentRootPath, ClasspathEntry.NO_ACCESS_RULES, ClasspathEntry.NO_EXTRA_ATTRIBUTES, false);
    }
    ...
    public static IClasspathEntry newLibraryEntry(IPath path, IPath sourceAttachmentPath, IPath sourceAttachmentRootPath, IAccessRule[] accessRules, IClasspathAttribute[] extraAttributes, boolean isExported) {
        ...
        if (sourceAttachmentPath != null) {
            if (sourceAttachmentPath.isEmpty()) {
                ...
                throw new ClasspathEntry.AssertionFailedException(//$NON-NLS-1$
                "Source attachment path '" + sourceAttachmentPath + //$NON-NLS-1$
                "' for IClasspathEntry must be absolute");
            }
        }
        return new ClasspathEntry(IPackageFragmentRoot.K_BINARY, IClasspathEntry.CPE_LIBRARY, hasDotDot ? path : JavaProject.createPackageFragementKey(path), // inclusion patterns
        ClasspathEntry.INCLUDE_ALL, // exclusion patterns
    ...
    public static IClasspathEntry newSourceEntry(IPath path) {
        return newSourceEntry(path, ClasspathEntry.INCLUDE_ALL, ClasspathEntry.EXCLUDE_NONE, null);
    }
    ...
    public static void removeClasspathVariable(String variableName, IProgressMonitor monitor) {
        try {
            SetVariablesOperation operation = new SetVariablesOperation(new String[] { variableName }, new IPath[] { null }, true);
