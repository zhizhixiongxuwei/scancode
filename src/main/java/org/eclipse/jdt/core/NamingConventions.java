...
public final class NamingConventions {
    ...
    //$NON-NLS-1$
    static final public char[] GETTER_BOOL_NAME = "is".toCharArray();

    //$NON-NLS-1$
    static final public char[] GETTER_NAME = "get".toCharArray();

    //$NON-NLS-1$
    static final public char[] SETTER_NAME = "set".toCharArray();
