...
public final class JavaConventions {
    ...
    //$NON-NLS-1$
    static final public Pattern DOT_DOT = Pattern.compile("(\\.)(\\1)+");

    //$NON-NLS-1$
    static final public Pattern PREFIX_JAVA = Pattern.compile("java$");

    static final public Scanner SCANNER = new Scanner(false, /*comment*/
    true, /*whitespace*/
    false, /*nls*/
    ...
    static public Map<String, Set<String>> restrictedIdentifiersMap, restrictedIdentifierPreviewMap;
    ...
    public static IStatus validateCompilationUnitName(String name, String sourceLevel, String complianceLevel) {
        ...
        if (!CharOperation.equals(identifier.toCharArray(), TypeConstants.PACKAGE_INFO_NAME) && !CharOperation.equals(identifier.toCharArray(), TypeConstants.MODULE_INFO_NAME)) {
