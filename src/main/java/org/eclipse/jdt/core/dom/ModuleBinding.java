...
public class ModuleBinding implements IModuleBinding {
    ...
    public boolean isEqualTo(IBinding other) {
        if (// identical binding - equal (key or no key)
        other == this)
            return true;
        if (// other binding missing
        other == null)
            return false;
    ...
    public IPackageBinding[] getExportedPackages() {
        if (this.exports == null) {
            ...
            this.exports = Arrays.stream(compilerExports).map(e -> this.resolver.getPackageBinding(e)).toArray(IPackageBinding[]::new);
        }
        return this.exports;
    }
    ...
    public IPackageBinding[] getOpenedPackages() {
        if (this.opens == null) {
            ...
            this.opens = Arrays.stream(compilerOpens).map(o -> this.resolver.getPackageBinding(o)).toArray(IPackageBinding[]::new);
        }
        return this.opens;
    }
