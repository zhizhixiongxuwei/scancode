...
public final class TagElement extends AbstractTagElement {
     ...
     */
    public static final ChildListPropertyDescriptor FRAGMENTS_PROPERTY = internalFragmentsPropertyFactory(TagElement.class);

    /**
     * The "properties" structural property of this node type (element type: {@link TagProperty}).
     * @since 3.30
     */
    public static final ChildListPropertyDescriptor TAG_PROPERTIES_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(TagElement.class, "tagProperties", TagProperty.class, CYCLE_RISK);
     ...
     * @since 3.30
     */
    static final public List PROPERTY_DESCRIPTORS_18;
     ...
     */
    private final ASTNode.NodeList tagProperties = new ASTNode.NodeList(TAG_PROPERTIES_PROPERTY);
