...
public class BreakStatement extends Statement {
    ...
    new ChildPropertyDescriptor(BreakStatement.class, "expression", Expression.class, OPTIONAL, NO_CYCLE_RISK);
     ...
     */
    public SimpleName optionalLabel = null;
    ...
    @Override
    int treeSize() {
        return memSize() + (this.optionalLabel == null ? 0 : getLabel().treeSize()) + (this.optionalExpression == null ? 0 : getExpression().treeSize());
    }
}
