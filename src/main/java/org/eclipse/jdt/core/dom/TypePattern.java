...
public class TypePattern extends Pattern {
     ...
     */
    public static final ChildPropertyDescriptor PATTERN_VARIABLE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(TypePattern.class, "patternVariable", SingleVariableDeclaration.class, MANDATORY, CYCLE_RISK);

    /**
     * The "patternVariable" structural property of this node type (child type: {@link VariableDeclaration}).
     * @since 3.39
     */
    public static final ChildPropertyDescriptor PATTERN_VARIABLE_PROPERTY2 = //$NON-NLS-1$
    new ChildPropertyDescriptor(TypePattern.class, "patternVariable2", VariableDeclaration.class, MANDATORY, CYCLE_RISK);
     ...
     */
    static final public List PROPERTY_DESCRIPTORS;
     ...
     * @since 3.38
     */
    static final public List PROPERTY_DESCRIPTORS_2_0;
     ...
     */
    volatile public SingleVariableDeclaration patternVariable;
    ...
    public SingleVariableDeclaration getPatternVariable() {
        ...
        if (this.patternVariable == null) {
            ...
            synchronized (this) {
                if (this.patternVariable == null) {
                    preLazyInit();
                    this.patternVariable = postLazyInit(new SingleVariableDeclaration(this.ast), PATTERN_VARIABLE_PROPERTY);
                }
            }
        }
    ...
    public VariableDeclaration getPatternVariable2() {
        ...
        if (this.patternVariable2 == null) {
            ...
            synchronized (this) {
                if (this.patternVariable2 == null) {
                    preLazyInit();
                    this.patternVariable2 = postLazyInit(new SingleVariableDeclaration(this.ast), PATTERN_VARIABLE_PROPERTY2);
                }
            }
        }
    ...
    @Override
    int treeSize() {
        return memSize() + (this.patternVariable2 == null ? getPatternVariable().treeSize() : getPatternVariable2().treeSize());
    }
}
