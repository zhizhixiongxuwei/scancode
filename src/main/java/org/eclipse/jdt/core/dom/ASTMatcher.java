...
public class ASTMatcher {
     ...
     * @since 3.0
     */
    final public boolean matchDocTags;
    ...
    public boolean match(CompilationUnit node, Object other) {
        ...
        return ((node.getAST().apiLevel >= AST.JLS9_INTERNAL ? safeSubtreeMatch(node.getModule(), o.getModule()) : true) && safeSubtreeMatch(node.getPackage(), o.getPackage()) && safeSubtreeListMatch(node.imports(), o.imports()) && safeSubtreeListMatch(node.types(), o.types()));
    }
    ...
    public boolean match(GuardedPattern node, Object other) {
        ...
        return safeSubtreeMatch(node.getPattern(), o.getPattern()) && safeSubtreeMatch(node.getExpression(), o.getExpression());
    }
    ...
    public boolean match(JavaDocRegion node, Object other) {
        ...
        return safeEquals(node.getTagName(), o.getTagName()) && safeSubtreeListMatch(node.tags(), o.tags()) && safeSubtreeListMatch(node.fragments(), o.fragments()) && safeEquals(node.isDummyRegion(), o.isDummyRegion() && safeEquals(node.isValidSnippet(), o.isValidSnippet()));
    }
    ...
    public boolean match(ModuleDeclaration node, Object other) {
        ...
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeListMatch(node.annotations(), o.annotations()) && node.isOpen() == o.isOpen() && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.moduleStatements(), o.moduleStatements()));
    }
    ...
    public boolean match(PatternInstanceofExpression node, Object other) {
        ...
        return safeSubtreeMatch(node.getLeftOperand(), o.getLeftOperand()) && safeSubtreeMatch(node.getPattern(), o.getPattern());
    }
    ...
    public boolean match(PrimitiveType node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return (level >= AST.JLS8_INTERNAL ? safeSubtreeListMatch(node.annotations(), o.annotations()) : true) && node.getPrimitiveTypeCode() == o.getPrimitiveTypeCode();
    }
    ...
    public boolean match(ProvidesDirective node, Object other) {
        ...
        return (safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.implementations(), o.implementations()));
    }
    ...
    public boolean match(ModuleQualifiedName node, Object other) {
        ...
        return safeSubtreeMatch(node.getModuleQualifier(), o.getModuleQualifier()) && safeSubtreeMatch(node.getName(), o.getName());
    }
    ...
    public boolean match(QualifiedType node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return safeSubtreeMatch(node.getQualifier(), o.getQualifier()) && (level >= AST.JLS8_INTERNAL ? safeSubtreeListMatch(node.annotations(), o.annotations()) : true) && safeSubtreeMatch(node.getName(), o.getName());
    }
    ...
    public boolean match(RecordDeclaration node, Object other) {
        ...
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeListMatch(node.modifiers(), o.modifiers()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.superInterfaceTypes(), o.superInterfaceTypes()) && safeSubtreeListMatch(node.typeParameters(), o.typeParameters()) && safeSubtreeListMatch(node.bodyDeclarations(), o.bodyDeclarations()) && safeSubtreeListMatch(node.recordComponents(), o.recordComponents()));
    }
    ...
    public boolean match(RecordPattern node, Object other) {
        ...
        return safeSubtreeMatch(node.getPatternType(), o.getPatternType()) && safeSubtreeListMatch(node.patterns(), o.patterns());
    }
    ...
    public boolean match(SimpleType node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return (level >= AST.JLS8_INTERNAL ? safeSubtreeListMatch(node.annotations(), o.annotations()) : true) && safeSubtreeMatch(node.getName(), o.getName());
    }
    ...
    public boolean match(SingleVariableDeclaration node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return (level >= AST.JLS3_INTERNAL ? safeSubtreeListMatch(node.modifiers(), o.modifiers()) : node.getModifiers() == o.getModifiers()) && safeSubtreeMatch(node.getType(), o.getType()) && (level >= AST.JLS8_INTERNAL && node.isVarargs() ? safeSubtreeListMatch(node.varargsAnnotations(), o.varargsAnnotations()) : true) && (level >= AST.JLS3_INTERNAL ? node.isVarargs() == o.isVarargs() : true) && safeSubtreeMatch(node.getName(), o.getName()) && ((level >= AST.JLS8_INTERNAL) ? safeSubtreeListMatch(node.extraDimensions(), o.extraDimensions()) : node.getExtraDimensions() == o.getExtraDimensions()) && safeSubtreeMatch(node.getInitializer(), o.getInitializer());
    }
    ...
    public boolean match(SwitchCase node, Object other) {
        ...
        return (node.getAST().apiLevel >= AST.JLS14_INTERNAL ? safeSubtreeListMatch(node.expressions(), o.expressions()) : compareDeprecatedSwitchExpression(node, o));
    }
    ...
    public boolean match(TagElement node, Object other) {
        ...
        return (safeEquals(node.getTagName(), o.getTagName()) && safeSubtreeListMatch(node.fragments(), o.fragments()) && (DOMASTUtil.isJavaDocCodeSnippetSupported(node.getAST().apiLevel) ? safeSubtreeListMatch(node.tagProperties(), o.tagProperties()) : true));
    }
    ...
    public boolean match(TagProperty node, Object other) {
        ...
        return (safeEquals(node.getName(), o.getName()) && safeEquals(node.getStringValue(), o.getStringValue())) && safeSubtreeMatch(node.getNodeValue(), o.getNodeValue());
    }
    ...
    public boolean match(TypeParameter node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return (level >= AST.JLS8_INTERNAL ? safeSubtreeListMatch(node.modifiers(), o.modifiers()) : true) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.typeBounds(), o.typeBounds());
    }
    ...
    public boolean match(VariableDeclarationFragment node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return safeSubtreeMatch(node.getName(), o.getName()) && (level >= AST.JLS8_INTERNAL ? safeSubtreeListMatch(node.extraDimensions(), o.extraDimensions()) : node.getExtraDimensions() == o.getExtraDimensions()) && safeSubtreeMatch(node.getInitializer(), o.getInitializer());
    }
    ...
    public boolean match(WildcardType node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return (level >= AST.JLS8_INTERNAL ? safeSubtreeListMatch(node.annotations(), o.annotations()) : true) && node.isUpperBound() == o.isUpperBound() && safeSubtreeMatch(node.getBound(), o.getBound());
    }
    ...
    public boolean match(ImplicitTypeDeclaration node, Object other) {
        ...
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeListMatch(node.bodyDeclarations(), o.bodyDeclarations()));
    }
}
