...
public class ModuleQualifiedName extends Name {
     ...
     */
    public static final ChildPropertyDescriptor MODULE_QUALIFIER_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(ModuleQualifiedName.class, "moduleQualifier", SimpleName.class, MANDATORY, CYCLE_RISK);

    /**
     * The "name" structural property of this node type (child type: {@link SimpleName}).	 *
     */
    public static final ChildPropertyDescriptor NAME_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(ModuleQualifiedName.class, "name", QualifiedName.class, MANDATORY, NO_CYCLE_RISK);
     ...
     * Java identifier.
     */
    volatile public Name moduleQualifier;
