...
public class SwitchCase extends Statement {
     ...
     * @since 3.18
     */
    public static final ChildListPropertyDescriptor EXPRESSIONS2_PROPERTY = //$NON-NLS-1$);
    new ChildListPropertyDescriptor(SwitchCase.class, "expression", Expression.class, CYCLE_RISK);

    /**
     * The "switchLabeledRule" structural property of this node type (type: {@link Boolean}).
     * @since 3.18
     */
    public static final SimplePropertyDescriptor SWITCH_LABELED_RULE_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(SwitchCase.class, "switchLabeledRule", boolean.class, MANDATORY);
     ...
     * or null if uninitialized.
     */
    static final public List PROPERTY_DESCRIPTORS_13;
