...
public class SimpleName extends Name {
     ...
     * @since 3.14
     */
    public static final SimplePropertyDescriptor VAR_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(SimpleName.class, "var", boolean.class, MANDATORY);
     ...
     * @since 3.14
     */
    static final public List PROPERTY_DESCRIPTORS_10_0;
     ...
     */
    //$NON-NLS-1$
    static final public String MISSING_IDENTIFIER = "MISSING";
