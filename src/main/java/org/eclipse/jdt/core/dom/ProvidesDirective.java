...
public class ProvidesDirective extends ModuleDirective {
    ...
    new ChildPropertyDescriptor(ProvidesDirective.class, "name", Name.class, MANDATORY, NO_CYCLE_RISK);

    /**
     * The "implementations" structural property of this node type (element type: {@link Name}).
     */
    public static final ChildListPropertyDescriptor IMPLEMENTATIONS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(ProvidesDirective.class, "implementations", Name.class, NO_CYCLE_RISK);
     ...
     */
    static final public List PROPERTY_DESCRIPTORS_9_0;
     ...
     */
    final public ASTNode.NodeList implementations = new ASTNode.NodeList(IMPLEMENTATIONS_PROPERTY);
    ...
    public Name getName() {
        if (this.name == null) {
            ...
            synchronized (this) {
                if (this.name == null) {
                    preLazyInit();
                    this.name = postLazyInit(this.ast.newQualifiedName(new SimpleName(this.ast), new SimpleName(this.ast)), NAME_PROPERTY);
                }
            }
        }
        return this.name;
