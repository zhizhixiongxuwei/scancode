...
public abstract class VariableDeclaration extends ASTNode {
     ...
     */
    volatile public SimpleName variableName;
     ...
     */
    public int extraArrayDimensions = 0;
     ...
     * @since 3.10
     */
    public ASTNode.NodeList extraDimensions = null;

    /**
     * The initializer expression, or <code>null</code> if none;
     * defaults to none.
     */
    public Expression optionalInitializer = null;
