...
public class SwitchExpression extends Expression {
    ...
    new ChildPropertyDescriptor(SwitchExpression.class, "expression", Expression.class, MANDATORY, CYCLE_RISK);
    ...
    new ChildListPropertyDescriptor(SwitchExpression.class, "statements", Statement.class, CYCLE_RISK);
     ...
     * expression.
     */
    volatile public Expression expression;
     ...
     */
    final public ASTNode.NodeList statements = new ASTNode.NodeList(STATEMENTS_PROPERTY);
