...
public class RequiresDirective extends ModuleDirective {
    ...
    new ChildListPropertyDescriptor(RequiresDirective.class, "modifiers", ModuleModifier.class, NO_CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(RequiresDirective.class, "name", Name.class, MANDATORY, NO_CYCLE_RISK);
     ...
     */
    final public ASTNode.NodeList modifiers = new ASTNode.NodeList(MODIFIERS_PROPERTY);
    ...
    @Override
    int treeSize() {
        return memSize() + (this.modifiers == null ? 0 : this.modifiers.listSize()) + (this.name == null ? 0 : getName().treeSize());
    }
}
