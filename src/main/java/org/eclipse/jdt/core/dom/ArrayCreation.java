...
public class ArrayCreation extends Expression {
     ...
     * legal array type.
     */
    volatile public ArrayType arrayType;

    /**
     * The list of dimension expressions (element type:
     * {@link Expression}). Defaults to an empty list.
     */
    private final ASTNode.NodeList dimensions = new ASTNode.NodeList(DIMENSIONS_PROPERTY);
    ...
    public ArrayType getType() {
        if (this.arrayType == null) {
            ...
            synchronized (this) {
                if (this.arrayType == null) {
                    preLazyInit();
                    this.arrayType = postLazyInit(this.ast.newArrayType(this.ast.newPrimitiveType(PrimitiveType.INT)), TYPE_PROPERTY);
                }
            }
        }
