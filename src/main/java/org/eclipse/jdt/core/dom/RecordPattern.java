...
public class RecordPattern extends Pattern {
     ...
     */
    public static final ChildListPropertyDescriptor PATTERNS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(RecordPattern.class, "patterns", Pattern.class, CYCLE_RISK);

    /**
     * The "patternType" structural property of this node type (child type: {@link Type}).
     */
    public static final ChildPropertyDescriptor PATTERN_TYPE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(RecordPattern.class, "patternType", Type.class, MANDATORY, CYCLE_RISK);
     ...
     * The pattern type;
     */
    volatile public Type patternType;
     ...
     */
    final public ASTNode.NodeList patterns = new ASTNode.NodeList(PATTERNS_PROPERTY);
    ...
    public Type getPatternType() {
        ...
        if (this.patternType == null) {
            ...
            synchronized (this) {
                if (this.patternType == null) {
                    preLazyInit();
                    this.patternType = postLazyInit(this.ast.newPrimitiveType(PrimitiveType.INT), PATTERN_TYPE_PROPERTY);
                }
            }
        }
