...
public class GuardedPattern extends Pattern {
    ...
    new ChildPropertyDescriptor(GuardedPattern.class, "expression", Expression.class, MANDATORY, CYCLE_RISK);
     ...
     */
    public int restrictedIdentifierStartPosition = -1;
     ...
     */
    volatile public Pattern pattern;
    ...
    @Override
    int treeSize() {
        return memSize() + (this.pattern == null ? 0 : getPattern().treeSize()) + (this.conditionalExpression == null ? 0 : getExpression().treeSize());
    }
