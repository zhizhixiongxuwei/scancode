...
public class Javadoc extends Comment {
     ...
     */
    public static final SimplePropertyDescriptor MARKDOWN_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(Javadoc.class, "static", boolean.class, MANDATORY);
     ...
     * @since 3.1
     */
    static final public List PROPERTY_DESCRIPTORS_3_0;
