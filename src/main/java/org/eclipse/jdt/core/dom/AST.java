...
public final class AST {
     ...
     * @since 3.0
     */
    static final public Class[] AST_CLASS = new Class[] { AST.class };
     ...
     */
    /*package*/
    static final public int JLS2_INTERNAL = JLS2;
     ...
     */
    /*package*/
    static final public int JLS3_INTERNAL = JLS3;
     ...
     */
    /*package*/
    static final int JLS8_INTERNAL = JLS8;
     ...
     */
    /*package*/
    static final int JLS9_INTERNAL = JLS9;
     ...
     */
    /*package*/
    static final int JLS10_INTERNAL = JLS10;
     ...
     */
    /*package*/
    static final int JLS11_INTERNAL = JLS11;
    ...
    private AST(int level, boolean previewEnabled) {
        ...
        switch(level) {
            case JLS8_INTERNAL:
                ...
                this.scanner = new Scanner(true, /*comment*/
                true, /*whitespace*/
                false, /*nls*/
    ...
    public AST(Map options) {
        this(apiLevelMap.get(options.get(JavaCore.COMPILER_SOURCE)), JavaCore.ENABLED.equals(options.get(JavaCore.COMPILER_PB_ENABLE_PREVIEW_FEATURES)));
