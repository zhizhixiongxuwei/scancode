...
public final class ModuleModifier extends ASTNode {
    ...
    public static class ModuleModifierKeyword {
         ...
         */
        //$NON-NLS-1$
        public static final ModuleModifierKeyword STATIC_KEYWORD = new ModuleModifierKeyword("static", STATIC_PHASE);

        /**
         * "transitive" modifier with flag value {@link ModuleModifier#TRANSITIVE}.
         */
        //$NON-NLS-1$
        public static final ModuleModifierKeyword TRANSITIVE_KEYWORD = new ModuleModifierKeyword("transitive", TRANSITIVE);
    ...
    new SimplePropertyDescriptor(ModuleModifier.class, "keyword", ModuleModifier.ModuleModifierKeyword.class, MANDATORY);
