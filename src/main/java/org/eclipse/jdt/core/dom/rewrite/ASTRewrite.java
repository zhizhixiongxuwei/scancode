...
public class ASTRewrite {
     ...
     * @since 3.1
     */
    public TargetSourceRangeComputer targetSourceRangeComputer = null;
    ...
    public TextEdit rewriteAST() throws JavaModelException, IllegalArgumentException {
        ...
        Map options = typeRoot instanceof ICompilationUnit ? ((ICompilationUnit) typeRoot).getOptions(true) : typeRoot.getJavaProject().getOptions(true);
    ...
    private void validatePropertyType(StructuralPropertyDescriptor prop, Object value) {
        ...
        if (value == null) {
            ...
            if (!valueType.isAssignableFrom(value.getClass())) {
                ...
                value.getClass().getName() + " is not a valid type for " + prop.getNodeClass().getName() + " property '" + prop.getId() + //$NON-NLS-1$
                '\'';
                throw new IllegalArgumentException(message);
            }
        }
