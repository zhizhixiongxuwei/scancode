...
public class CompilationUnit extends ASTNode {
     ...
     */
    static final public Message[] EMPTY_MESSAGES = new Message[0];

    /**
     * Canonical empty list of problems.
     */
    static final public IProblem[] EMPTY_PROBLEMS = new IProblem[0];
     ...
     * @since 3.14
     */
    public static final ChildPropertyDescriptor MODULE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(CompilationUnit.class, "module", ModuleDeclaration.class, OPTIONAL, NO_CYCLE_RISK);
     ...
     */
    private final ASTNode.NodeList imports = new ASTNode.NodeList(IMPORTS_PROPERTY);
