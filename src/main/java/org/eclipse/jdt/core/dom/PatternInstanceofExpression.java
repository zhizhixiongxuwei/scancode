...
public class PatternInstanceofExpression extends Expression {
    ...
    new ChildPropertyDescriptor(PatternInstanceofExpression.class, "leftOperand", Expression.class, MANDATORY, CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(PatternInstanceofExpression.class, "rightOperand", SingleVariableDeclaration.class, MANDATORY, CYCLE_RISK);

    /**
     * The "pattern" structural property of this node type (child type: {@link Pattern}).
     * @since 3.34
     */
    public static final ChildPropertyDescriptor PATTERN_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(PatternInstanceofExpression.class, "pattern", Pattern.class, MANDATORY, CYCLE_RISK);
     ...
     */
    static final public List PROPERTY_DESCRIPTORS_16;
     ...
     * @since 3.33
     */
    static final public List PROPERTY_DESCRIPTORS_20;
    ...
    @Override
    int treeSize() {
        return memSize() + (this.leftOperand == null ? 0 : getLeftOperand().treeSize()) + ((this.ast.apiLevel < AST.JLS20_INTERNAL) ? (this.rightOperand == null ? 0 : getRightOperand().treeSize()) : (this.pattern == null ? 0 : getPattern().treeSize()));
    }
}
