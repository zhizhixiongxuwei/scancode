...
public class StringLiteral extends Expression {
    ...
    public String getLiteralValue() {
        ...
        Scanner scanner = new Scanner(this.ast.scanner.tokenizeComments, this.ast.scanner.tokenizeWhiteSpace, this.ast.scanner.checkNonExternalizedStringLiterals, this.ast.scanner.sourceLevel, this.ast.scanner.complianceLevel, this.ast.scanner.taskTags, this.ast.scanner.taskPriorities, this.ast.scanner.isTaskCaseSensitive, this.ast.scanner.previewEnabled);
        ...
        try {
            ...
            switch(tokenType) {
                ...
                default:
                    //$NON-NLS-1$
                    throw new IllegalArgumentException("tokenType: " + tokenType);
            }
        } catch (InvalidInputException e) {
